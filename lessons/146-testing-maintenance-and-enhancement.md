# Lesson 146: Testing, maintenance and enhancement
...
4. Give one normal mark for 0 to 100 inclusive.
   **Answer:** Any valid non-boundary value, for example 55.
5. Give two valid extreme values.
   **Answer:** 0 and 100.
6. Give one abnormal boundary value.
   **Answer:** -1 or 101.
7. Why does maintenance continue after acceptance?
   **Answer:** Faults, environmental changes and requested improvements continue after delivery.
8. Which type changes software for a new external rule?
   **Answer:** Adaptive maintenance.
9. Which type adds useful functionality or improves performance?
   **Answer:** Perfective maintenance.
10. What should be recorded before changing existing code?
   **Answer:** Its purpose, inputs, outputs, relevant control/data flow, assumptions and behaviour that must remain unchanged.
11. Why rerun old tests after adding a feature?
   **Answer:** Regression tests check that the amendment has not broken existing behaviour.
12. How is an enhancement different from merely correcting a fault?
...
- **Delivery:** CORE / TEACH
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-138-boundary.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** CORE / TEACH
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-139-bug.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** CORE / TEACH
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-146-changeover.jpg`
...
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-146-data-tool.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-146-implementation.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** CORE / TEACH
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-146-maintenance.jpg`
...
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-146-stage-tool.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** CORE / TEACH
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-146-test-data.jpg`
