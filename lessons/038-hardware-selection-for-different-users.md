# Lesson 038: Hardware selection for different users
...
1. Describe the purpose of **Hardware selection for different users** using accurate Cambridge AS Computer Science vocabulary.
...
Lesson-specific focus question: What would go wrong if a student confused **Hardware selection for different users** with a neighbouring syllabus idea?
...
Topic-specific teaching move: keep the explanation anchored to **Hardware selection for different users**. Students must produce one clear sentence that names the mechanism, one example that uses it, and one exam trap connected to it.
...
## Worked Example
**Problem:** Choose suitable hardware for a school attendance system and justify two choices. The worked example must explicitly use **Hardware selection for different users**, not a generic example from the wider unit.
...
## Student Task
Teams design a hardware set-up for a specific user: librarian, weather station, exam office or delivery driver. They must reject one tempting but unsuitable device. Their final answer must include the phrase **Hardware selection for different users** and one short Chinese support note explaining the hardest word.

## Mini-Quiz
1. State one precise definition connected to **Hardware selection for different users**.
2. Complete one calculation, trace, SQL clause, diagram label or scenario explanation from the lesson.
3. Write one sentence that uses "therefore" to link the concept to a consequence.

## Exit Ticket
Complete this sentence in English:  
"The key point about **Hardware selection for different users** is..., and a common mistake is..."

## Homework
- Create three flashcards: one definition, one worked example, one common trap.
- Answer one 4-mark question about **Hardware selection for different users** using the structure: point, explanation, context, consequence.
