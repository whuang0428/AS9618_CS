...
1. Describe the purpose of **Wired and wireless transmission media** using accurate Cambridge AS Computer Science vocabulary.
...
Lesson-specific focus question: What would go wrong if a student confused **Wired and wireless transmission media** with a neighbouring syllabus idea?
...
Topic-specific teaching move: keep the explanation anchored to **Wired and wireless transmission media**. Students must produce one clear sentence that names the mechanism, one example that uses it, and one exam trap connected to it.
...
## Worked Example
**Problem:** A student cannot access a secure web page on the school network. Identify two possible network-related causes and one suitable check for each. The worked example must explicitly use **Wired and wireless transmission media**, not a generic example from the wider unit.
...
## Student Task
Students draw a packet journey for a web request and label where addressing, routing and protocols are used. They then add one bottleneck and explain its effect. Their final answer must include the phrase **Wired and wireless transmission media** and one short Chinese support note explaining the hardest word.

## Mini-Quiz
1. State one precise definition connected to **Wired and wireless transmission media**.
2. Complete one calculation, trace, SQL clause, diagram label or scenario explanation from the lesson.
3. Write one sentence that uses "therefore" to link the concept to a consequence.

## Exit Ticket
Complete this sentence in English:  
"The key point about **Wired and wireless transmission media** is..., and a common mistake is..."

## Homework
- Create three flashcards: one definition, one worked example, one common trap.
- Answer one 4-mark question about **Wired and wireless transmission media** using the structure: point, explanation, context, consequence.
