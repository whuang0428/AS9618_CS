# Lesson 068: Digital signatures and encryption
...
|---|---|---:|
| sender creates a hash of the message | Do not award confidentiality as the purpose of a signature or integrity/authenticity as an automatic result of encryption alone. | 1 |
| hash is signed/encrypted using sender's private key |  | 1 |
| receiver uses sender's public key and hashes received message |  | 1 |
| matching hashes provide integrity and sender-authenticity evidence |  | 1 |
| separate encryption converts message plaintext to ciphertext |  | 1 |
| confidentiality requires the correct decryption key |  | 1 |
<!-- stage2-practice:end -->
...
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-068-certificates.jpg`
...
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-068-compare.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-068-encryption.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-068-hashing.jpg`
...
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-068-https.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-068-keys.jpg`
