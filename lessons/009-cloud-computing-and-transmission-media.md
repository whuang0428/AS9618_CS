...
- **dedicated to one organisation:** A private cloud is dedicated to one organisation…
...
3. **Justify against the scenario** — A private cloud is restricted to one organisation.

**Cloud services:** Cloud services provide storage, software or computing resources from remote servers over a network. The user does not need to own all the local infrastructure. Cloud storage
...
- Servers, processing power or databases are rented from a provider instead of bought and maintained locally.
- Example: hosting a school portal on remote servers.
- Common error
- Cloud advantages are not automatic. A strong answer links the benefit or risk to a scenario: remote access, collaboration, backup, scalability, provider dependence, security, privacy or internet connection.
...
- **physical cable:** Comparisons must connect physical cable or radio transmission…
...
3. **Match a safeguard and limitation** — A wireless network transmits through the air, supporting mobility and rapid installation, but shared radio capacity, interference, obstacles…

**Compare by factor, not by vibe:** Wired networks Wireless networks
...
- Security
- Physical access to the cable is usually needed to intercept traffic.
- Signals travel through air, so encryption and access control are important.
- Performance
...
- **radio waves:** Radio waves are used by technologies such as…
- **WiFi:** Radio waves, including WiFi, support non-line-of-sight local wireless…
...
3. **Connect output to its use** — Radio waves, including WiFi, support non-line-of-sight local wireless access but can be absorbed, reflected or interfered with.

**Wired transmission media:** Wired media carry signals through a physical cable. They are usually suitable for fixed devices and controlled environments. Copper cable
...
- Good for: high-bandwidth links, long distances, backbone connections.
- Strengths: less affected by electromagnetic interference and can support high data rates.
- Limits: installation can be more expensive and the cable can be more delicate to handle.
...
- Limits: obstacles, weather and alignment can affect the link.
- Satellites
- Satellite communication uses signals to and from satellites to cover large geographical areas.
- Good for: remote locations, ships, aircraft or areas without cable infrastructure.
