...
- **S4.07.A01:** fetch-execute cycle / fetch decode execute / fetch-decode-execute cycle
- **S4.07.A02:** register transfer notation / register-transfer notation
...
1. **Establish the exact components or states** — The fetch-execute cycle using register transfer notation.
2. **Trace the relationship or change** — Register-transfer notation describes a data transfer or register update.
3. **Use the explanation in a concrete case** — The arrow <- means 'is loaded with' or 'receives';

#### Worked example: The fetch-execute cycle using register transfer notation: complete worked route
...
Register-transfer notation describes a data transfer or register update.

3. **Use the explanation in a concrete case**

The arrow <- means 'is loaded with' or 'receives';
...
#### Mastery check (MC-L021-S4.07)

Describe the following targets in one connected answer, using a concrete example for each: fetch-execute cycle / fetch decode execute / fetch-decode-execute cycle; register transfer notation / register-transfer notation.
...
- S4.07: explain fetch-execute cycle / fetch decode execute / fetch-decode-execute cycle, register transfer notation / register-transfer notation.
- S4.07 method: Establish the exact components or states → Trace the relationship or change → Use the explanation in a concrete case.
