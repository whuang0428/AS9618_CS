# Lesson 074: Count-controlled iteration
...
- **counter:** A count-controlled loop uses FOR...TO...NEXT when the repetition…
...
3. **Trace state and boundaries** — A count-controlled loop uses FOR...TO...NEXT when the repetition count or inclusive counter range is known before the loop…
...
Which keyword closes the count-controlled loop?
...
State two precise facts about count-controlled iteration.
...
Explain how count-controlled iteration would be applied in a suitable computing context.
...
- For count-controlled iteration, use the exact technical term before applying it to the scenario.
