# Lesson 066: User accounts, passwords and biometric authentication
...
4. Compare false accept from false reject.
...
|---|---|---:|
| account supplies a distinct identity/accountability record | Do not describe a biometric match as permission to access every resource or claim that biometrics cannot produce errors. | 1 |
| password is secret knowledge checked during authentication |  | 1 |
| password limitation such as guessing/phishing/reuse/sharing |  | 1 |
| biometric feature is captured and compared with an enrolled template |  | 1 |
| biometric limitation such as false accept/reject, sensor/template or privacy risk |  | 1 |
| authentication is distinguished from later authorisation/access rights |  | 1 |
<!-- stage2-practice:end -->
...
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-066-biometrics.jpg`
...
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-066-compare.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-066-factors.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-066-mfa.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-066-password-tool.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-066-passwords.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-066-tokens.jpg`
