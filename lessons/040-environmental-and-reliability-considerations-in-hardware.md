# Lesson 040: Environmental and reliability considerations in hardware
...
1. Identify the components and functions relevant to **Environmental and reliability considerations in hardware**.
...
Focus question: Which feature distinguishes **Environmental and reliability considerations in hardware** from the most closely related syllabus concept?
...
- Answer one 4-mark question about **Environmental and reliability considerations in hardware**. Follow its command word and apply each point to the stated context.
...
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-040-environment.jpg`
...
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-040-mitigation.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-040-reliability.jpg`
