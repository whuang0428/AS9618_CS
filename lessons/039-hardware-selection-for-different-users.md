# Lesson 039: Hardware selection for different users
...
1. Identify the components and functions relevant to **Hardware selection for different users**.
...
Focus question: Which feature distinguishes **Hardware selection for different users** from the most closely related syllabus concept?
...
- Answer one 4-mark question about **Hardware selection for different users**. Follow its command word and apply each point to the stated context.
...
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-039-categories.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-039-criteria.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-039-users.jpg`
