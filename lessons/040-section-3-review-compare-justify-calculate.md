...
1. Select the relevant concepts and command words for **Section 3 review: compare, justify, calculate**.
...
Focus question: Which feature distinguishes **Section 3 review: compare, justify, calculate** from the most closely related syllabus concept?
...
- Answer one 4-mark question about **Section 3 review: compare, justify, calculate**. Follow its command word and apply each point to the stated context.
