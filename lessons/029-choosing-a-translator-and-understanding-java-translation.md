...
- **S5.05.A01:** compiler
- **S5.05.A02:** interpreter
- **S5.05.A03:** advantages / benefits
- **S5.05.A04:** disadvantages / drawbacks
...
1. **Identify the relevant condition or input** — Compiler advantages include faster repeated execution after translation, distribution without the source code and translation checks across the whole program.
2. **Trace how the process works** — Disadvantages include a separate compilation step and an error list that may need several corrections before execution.
3. **Connect the mechanism to its result** — Interpreter advantages include immediate statement-level feedback and convenient incremental testing.

#### Worked example: Compare compiler and interpreter advantages/disadvantages and justify use: complete worked route

1. **Identify the relevant condition or input**

Compiler advantages include faster repeated execution after translation, distribution without the source code and translation checks across the whole program.

2. **Trace how the process works**

Disadvantages include a separate compilation step and an error list that may need several corrections before execution.

3. **Connect the mechanism to its result**

Interpreter advantages include immediate statement-level feedback and convenient incremental testing.
...
#### Mastery check (MC-L029-S5.05)

Explain the following targets in one connected answer, using a concrete example for each: compiler; interpreter; advantages / benefits; disadvantages / drawbacks.
...
- **S5.06.A02:** partly
- **S5.06.A03:** compiled
- **S5.06.A04:** interpreted

**Core explanation**

- Java in console mode is partly compiled and partly interpreted: the Java compiler translates source code into platform-independent bytecode, then a Java Virtual Machine (JVM) interprets that bytecode and may just-in-time compile parts for the host processor. Bytecode is not universal processor machine code.
- Java in console mode is partly compiled and partly interpreted
- A high-level program may be partly compiled and partly interpreted
- That Java is partly compiled and partly interpreted.

**Mechanism or method**

1. **Identify the relevant condition or input** — Java in console mode is partly compiled and partly interpreted: the Java compiler translates source code into platform-independent bytecode, then a Java Virtual Machine (JVM) interprets that bytecode and may just-in-time compile parts for the host processor.
2. **Trace how the process works** — Bytecode is not universal processor machine code.
3. **Connect the mechanism to its result** — Java in console mode is partly compiled and partly interpreted

#### Worked example: That Java is partly compiled and partly interpreted: complete worked route

1. **Identify the relevant condition or input**

Java in console mode is partly compiled and partly interpreted: the Java compiler translates source code into platform-independent bytecode, then a Java Virtual Machine (JVM) interprets that bytecode and may just-in-time compile parts for the host processor.

2. **Trace how the process works**

Bytecode is not universal processor machine code.
...
#### Mastery check (MC-L029-S5.06)

Explain the following targets in one connected answer, using a concrete example for each: Java; partly; compiled; interpreted.
...
- S5.05: explain compiler, interpreter, advantages / benefits, disadvantages / drawbacks.
- S5.05 method: Identify the relevant condition or input → Trace how the process works → Connect the mechanism to its result.
- S5.06: explain Java, partly, compiled, interpreted.
- S5.06 method: Identify the relevant condition or input → Trace how the process works → Connect the mechanism to its result.
