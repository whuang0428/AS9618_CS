...
1. Describe the purpose of **Choosing translation approaches for development and deployment** using accurate Cambridge AS Computer Science vocabulary.
...
Lesson-specific focus question: What would go wrong if a student confused **Choosing translation approaches for development and deployment** with a neighbouring syllabus idea?
...
Topic-specific teaching move: keep the explanation anchored to **Choosing translation approaches for development and deployment**. Students must produce one clear sentence that names the mechanism, one example that uses it, and one exam trap connected to it.
...
## Worked Example
**Problem:** A laptop is slow and storage is nearly full. Recommend two system software tools or OS actions and justify them. The worked example must explicitly use **Choosing translation approaches for development and deployment**, not a generic example from the wider unit.
...
## Student Task
Students sort cards into OS roles, utility software and application software, then defend two difficult cards. Their final answer must include the phrase **Choosing translation approaches for development and deployment** and one short Chinese support note explaining the hardest word.

## Mini-Quiz
1. State one precise definition connected to **Choosing translation approaches for development and deployment**.
...
- Answer one 4-mark question about **Choosing translation approaches for development and deployment** using the structure: point, explanation, context, consequence.
