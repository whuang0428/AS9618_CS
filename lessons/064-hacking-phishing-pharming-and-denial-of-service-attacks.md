...
1. Describe the purpose of **Hacking, phishing, pharming, and denial-of-service attacks** using accurate Cambridge AS Computer Science vocabulary.
...
Lesson-specific focus question: What would go wrong if a student confused **Hacking, phishing, pharming, and denial-of-service attacks** with a neighbouring syllabus idea?
...
Topic-specific teaching move: keep the explanation anchored to **Hacking, phishing, pharming, and denial-of-service attacks**. Students must produce one clear sentence that names the mechanism, one example that uses it, and one exam trap connected to it.
...
## Worked Example
**Problem:** A school stores exam marks online. Identify two risks and one control for each. The worked example must explicitly use **Hacking, phishing, pharming, and denial-of-service attacks**, not a generic example from the wider unit.
...
## Student Task
Groups create a risk-control table for a school database, online shop or hospital system. They must include one human weakness, not only technical attacks. Their final answer must include the phrase **Hacking, phishing, pharming, and denial-of-service attacks** and one short Chinese support note explaining the hardest word.

## Mini-Quiz
1. State one precise definition connected to **Hacking, phishing, pharming, and denial-of-service attacks**.
2. Complete one calculation, trace, SQL clause, diagram label or scenario explanation from the lesson.
3. Write one sentence that uses "therefore" to link the concept to a consequence.

## Exit Ticket
Complete this sentence in English:  
"The key point about **Hacking, phishing, pharming, and denial-of-service attacks** is..., and a common mistake is..."

## Homework
- Create three flashcards: one definition, one worked example, one common trap.
- Answer one 4-mark question about **Hacking, phishing, pharming, and denial-of-service attacks** using the structure: point, explanation, context, consequence.
