# Lesson 054: Required utility software
...
1. Describe the system-software functions involved in **Operating system roles: process, memory, file, and device management**.
...
Focus question: Which feature distinguishes **Operating system roles: process, memory, file, and device management** from the most closely related syllabus concept?
...
- Answer one 4-mark question about **Operating system roles: process, memory, file, and device management**. Follow its command word and apply each point to the stated context.
...
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-054-device.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-054-file.jpg`
...
- **Explanation type:** mechanism
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-054-memory.jpg`
...
- **Explanation type:** process
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-054-process.jpg`
...
- **Delivery:** OPTIONAL / EXTEND
- **Infographic:** `../assets/diagrams/stage10-infographics/stage10-lesson-054-services.jpg`
