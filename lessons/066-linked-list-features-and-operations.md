...
### 1. Stack, queue and linked-list features; justify a structure: Linked-list features and operations (S10.09)
...
#### Worked example: Stack, queue and linked-list features; justify a structure: Linked-list features and operations: complete worked route
...
- **link:** Their key features and justify which structure suits…
- **start:** Linked list uses Data and Next arrays (or…
- **next:** A linked list stores data plus a next…
- **stack:** Justify a stack, queue or linked list from…
- **queue:** Stack, queue and linked-list features
...
- **free list:** Linked list uses Data and Next arrays (or…
