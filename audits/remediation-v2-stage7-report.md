...
- Accessibility: 103425 solid text runs and 1874 gradient runs checked; contrast failures=0; target, language, ARIA, overflow, resource and console failures=0.
...
- Reproducibility: 21 safe generators ran twice; second-run changed files=0; manifest git diff exit=0.
- Release inventory/package: 1674 source rows; deterministic archive, sidecar, internal manifest and source parity passed.
