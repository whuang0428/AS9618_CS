...
| RV2-AUDIT-002 | Resolved | 95/95 CORE teaching pages place substantive CORE before Optional content; all 72 unique first-use pages are owned by declared requirements; All declared first-teaching concept groups pass, including vector, representations, devices, security, licensing, algorithms and ADT scope |
