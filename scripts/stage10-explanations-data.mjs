...
const visualTitleOverrides = Object.freeze({
  "099/concept": "An algorithm is a solution expressed as defined steps",
  "008/pixels": "Bitmap file header and pixel data",
  "011/resolution": "Sampling resolution: bits per sample",
  "035/sensors": "Required sensor types and applications",
  "044/main-registers": "The seven named register roles",
  "050/concept": "The official processor performance factors",
  "108/pseudocode": "Count vowels with a closed selection",
  "122/parse": "Use question-supplied CSV functions exactly",
  "122/pseudocode": "Question-supplied functions versus Java methods",
  "122/types": "Convert CSV text before numeric comparison",
  "047/structure": "Instruction labels and symbolic data addresses",
  "047/assembler": "Instruction groups: data movement, I/O, arithmetic, control and compare",
  "051/shifts": "Binary shifts: logical, arithmetic, cyclic",
  "048/effective": "Official LDR, CMI, JPE and JPN semantics",
  "048/modes": "Five addressing modes",
  "056/compare": "Choose the required utility by its operation",
  "087/join": "Two-table INNER JOIN with ON",
  "100/pattern": "Produce an abstract model",
  "112/analyser": "Stepwise refinement turns a high-level algorithm into implementable modules",
  "114/pseudocode": "The eight Cambridge pseudocode type names",
  "119/declare": "Define a record, then save and read named fields",
  "123/concept": "An ADT is data together with permitted operations",
  "123/implementation": "Implement stack, queue and linked list using arrays",
  "131/parameters": "A subprogram interface connects caller and header",
  "134/case": "LCASE and UCASE convert one CHAR",
  "134/concat": "Concatenation joins STRING values",
  "134/java": "MID and Java substring use different positions",
  "134/substring": "Use the string-function definition supplied in the question",
  "141/standard": "Translate a flowchart or structured English into pseudocode",
  "139/bug": "Analyse and amend an existing program",
  "145/algorithms": "Structure charts, derived pseudocode and state transitions",
  "146/changeover": "Test strategy and test plan are different documents",
  "075/ip": "What intellectual property can protect",
  "124/pseudocode": "Justify the data structure in Cambridge answers",
  "131/procedure": "A procedure performs actions and returns no value",
  "138/boundary": "Extreme or boundary data uses valid values at accepted limits",
  "138/erroneous": "Abnormal data is invalid data that should be rejected",
  "138/validation": "Testing checks validation against expected results",
  "146/evaluation": "Evaluation uses requirements and measurable success criteria",
});

const deliveryOverrides = Object.freeze({
  "051/compare": Object.freeze({ role: "OPTIONAL", activity: "EXTEND" }),
  "051/concept": Object.freeze({ role: "OPTIONAL", activity: "EXTEND" }),
  "051/hazards": Object.freeze({ role: "OPTIONAL", activity: "EXTEND" }),
  "051/stalls": Object.freeze({ role: "OPTIONAL", activity: "EXTEND" }),
  "051/timing": Object.freeze({ role: "OPTIONAL", activity: "EXTEND" }),
  "143/agile": Object.freeze({ role: "OPTIONAL", activity: "EXTEND" }),
});
...
const baseExplanations = [...pilotExplanations, ...rolloutExplanations];
const presentLessonIds = new Set(baseExplanations.map((item) => item.lesson));
const retainedSourceExplanations = Array.from({ length: 151 }, (_, index) => String(index + 1).padStart(3, "0"))
  .filter((lesson) => !presentLessonIds.has(lesson))
  .map((lesson) => {
    const moved = baseExplanations.find((item) => item.sourceLesson === lesson && item.lesson !== lesson);
    if (!moved) throw new Error(`Lesson ${lesson} has no maintained Stage 10 explanation source`);
    return Object.freeze({
      ...moved,
      lesson,
      targetId: moved.sourceTargetId,
      deliveryRole: "OPTIONAL",
      classroomActivity: "EXTEND",
      deliveryGroup: `syllabus-order-retained-${lesson}`,
    });
  });

export const explanations = Object.freeze([...baseExplanations, ...retainedSourceExplanations]
