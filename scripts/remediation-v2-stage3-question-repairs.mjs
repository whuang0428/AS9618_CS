...
export const stage3AssessmentEvidence = Object.freeze({
  "S2.15": [{ questionId: "L026-Q4", conceptGroups: [["IPv4"], ["IPv6"], ["public"], ["private"], ["static"], ["dynamic"]] }],
  "S2.16": [{ questionId: "L026-Q5", conceptGroups: [["scheme"], ["domain"], ["path"], ["DNS"], ["IP address"], ["WWW resource"]] }],
  "S3.05": [{ questionId: "L040-Q4", conceptGroups: [["RAM"], ["ROM"], ["volatile"], ["non-volatile"]] }],
  "S3.07": [{ questionId: "L040-Q5", conceptGroups: [["PROM"], ["EPROM"], ["EEPROM"]] }],
  "S8.06": [{ questionId: "L089-Q4", conceptGroups: [["developer interface"], ["query processor"]] }],
  "S11.07": [{ questionId: "L141-Q5", conceptGroups: [["function"], ["returns"], ["value"], ["expression"]] }],
  "S12.07": [{ questionId: "L147-Q3", conceptGroups: [["normal"], ["abnormal"], ["boundary"]] }],
  "S12.08": [{ questionId: "L146-Q4", conceptGroups: [["perfective"], ["adaptive"], ["corrective"], ["maintenance"]] }],
  "S12.09": [{ questionId: "L146-Q5", conceptGroups: [["analyse"], ["amend"], ["existing"], ["program"]] }],
});
