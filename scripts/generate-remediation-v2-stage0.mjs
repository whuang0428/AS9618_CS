...
const pagePaths = [
  ...
  ...Array.from({ length: 150 }, (_, index) => `web/lesson-${String(index + 1).padStart(3, "0")}/index.html`),
];
...
const issues = [
  ...
  },
  {
    ...
    category: "Coverage",
    severity: "P1",
    locations: ["scripts/syllabus-coverage-contract.json:345", "lessons/005-signed-binary-sign-and-magnitude-and-twos-complement.md:75"],
  ...
  },
  {
    ...
    severity: "P1",
    locations: ["lessons/006-binary-fractions-and-precision-limits.md:1", "lessons/011-sound-file-size-calculations.md:1", "lessons/113-data-types-integer-real-boolean-char-string-date-and-user-defined-types.md:1"],
  ...
  },
  {
    ...
    severity: "P1",
    locations: ["lessons/104-linear-search-and-binary-search.md:5", "lessons/114-constants-variables-and-assignment.md:5", "lessons/137-testing-with-normal-boundary-and-erroneous-data.md:5", "lessons/138-debugging-using-traces-and-breakpoints.md:5"],
    problem: "Lesson headers, course-map ranges and requirement mappings disagree about the owning syllabus section.",
    acceptanceTarget: "Stage 3 must make all 150 lesson identities agree across Markdown, HTML, catalogue, course map, contract and assessment mapping.",
  },
  {
    id: "RV2-WORD-001",
  ...
  },
  {
    ...
    severity: "P0",
    locations: ["lessons/049-performance-factors-cores-cache-clock-speed-and-word-length.md:145", "web/assets/diagrams/stage10-infographics/stage10-lesson-049-concept.jpg"],
  ...
  },
  {
    ...
    severity: "P0",
    locations: ["lessons/107-string-processing-algorithms.md:155", "lessons/133-string-handling-and-built-in-functions.md:49", "web/assets/diagrams/stage10-infographics/stage10-lesson-133-java.jpg"],
  ...
  },
  {
    ...
    severity: "P0",
    locations: ["lessons/121-csv-style-structured-text-files.md:128", "web/assets/diagrams/stage10-infographics/stage10-lesson-121-parse.jpg"],
