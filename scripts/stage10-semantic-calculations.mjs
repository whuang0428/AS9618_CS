...
export const semanticCalculations = Object.freeze([
  ...
  { id: "CALC-018-PROCEDURE-NESTING", key: "099/pseudocode", kind: "balanced-keywords", text: "PROCEDURE IF ELSE ENDIF ENDPROCEDURE", pairs: [["PROCEDURE", "ENDPROCEDURE"], ["IF", "ENDIF"]], description: "Procedure and nested IF are both closed" },
  { id: "CALC-019-DECISION-ENDIF", key: "100/equivalence", kind: "balanced-keywords", text: "IF THEN ELSE ENDIF", pairs: [["IF", "ENDIF"]], description: "Flowchart decision maps to a closed IF selection" },
  { id: "CALC-020-JAVA-SUM", key: "101/pseudocode", kind: "required-substrings", text: "int number = input.nextInt(); total += number; System.out.println(total);", required: ["input.nextInt()", "total += number", "System.out.println(total)"], description: "Java support code inputs, accumulates and outputs" },
  { id: "CALC-021-COUNT-ENDIF", key: "102/pseudocode", kind: "ordered-substrings", text: "IF Mark >= 50 THEN PassCount <- PassCount + 1 ENDIF NEXT Count", required: ["IF Mark", "PassCount <- PassCount + 1", "ENDIF", "NEXT Count"], description: "ENDIF precedes NEXT Count" },
