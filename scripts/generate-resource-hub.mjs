...
const resources = [
  ...
  ["Understanding mark schemes", "cambridge-ms-conventions.md", "How to read and use point-based Cambridge-style practice schemes."],
];
...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>AS9618 Resource Centre</title><link rel="icon" href="data:"><link rel="stylesheet" href="./styles.css"><link rel="stylesheet" href="../stage7-accessibility.css?v=3"><link rel="stylesheet" href="../academic-theme.css?v=7"></head>
...
<main id="main-content" tabindex="-1"><section class="intro"><h2>Reference material for study and exam practice</h2><p>Open a resource when needed. Cambridge pseudocode remains the Paper 2 answer standard; Java is supporting practice only.</p><p><a href="./practical-labs/">Programming practicals: learning route, runnable programs and test cases →</a></p></section><section class="resource-list">${cards}</section></main><script src="../stage7-accessibility.js?v=4"></script></body></html>`;
