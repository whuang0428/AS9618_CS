...
const specifications = {
  ...
  "RV2-COV-002": ["verify-batch6-section1-foundations.mjs", ["lessons/005-signed-binary-sign-and-magnitude-and-twos-complement.md", "scripts/syllabus-coverage-contract.json"]],
  ...
  "RV2-CONT-001": ["verify-remediation-v2-stage5.mjs", ["lessons/049-performance-factors-cores-cache-clock-speed-and-word-length.md", "scripts/remediation-v2-stage5-gate.mjs"]],
  "RV2-PSEUDO-001": ["verify-remediation-v2-stage5.mjs", ["lessons/107-string-processing-algorithms.md", "lessons/133-string-handling-and-built-in-functions.md"]],
  "RV2-PSEUDO-002": ["verify-remediation-v2-stage5.mjs", ["lessons/121-csv-style-structured-text-files.md", "scripts/remediation-v2-stage5-gate.mjs"]],
...
if (!defects.stageApprovals.some(({ stage }) => stage === 6)) defects.stageApprovals.push({ stage: 6, status: "ApprovedForProgression", recordedDate: "2026-08-28", releaseDecision: false });
