...
console.log(`Finalised Stage 7: RELEASE_CANDIDATE, ${independentReview.records.length}/16 issues revalidated, 308/308 browser records, ${releaseValidation.inventoryRows} release inventory rows.`);
