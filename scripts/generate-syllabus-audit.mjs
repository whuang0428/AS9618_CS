...
const lines = [
  ...
  `**Source of truth:** \`scripts/syllabus-coverage-contract.json\` (schema v${coverageContract.schemaVersion}) plus the locked independent official-source inventory. Runtime overrides are prohibited.`,
