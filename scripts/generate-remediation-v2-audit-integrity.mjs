...
if (!progressedBeyondAuditRepair) {
  defects.blockingSummary = "Audit-integrity repair is complete and awaiting progression approval. Stage 5 has not started; L050/L108/L122/L134 technical and image defects remain the three open P0 blockers.";
...
**Phase status:** Audit-integrity implementation complete${progressedBeyondAuditRepair ? "; the project has progressed beyond this historical repair phase." : "; awaiting user approval before Stage 5."}
