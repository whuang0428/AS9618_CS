...
const closures = Object.freeze({
  "RV2-SEQ-001": [
    ...
    "963-question sequence register records 520 formal and 443 Optional enrichment questions with zero before-CORE violations",
  ],
  "RV2-ID-001": [
    "All 150 stable lesson IDs and URLs are preserved; Markdown titles, HTML h1, course catalogue, paper and section ranges reconcile",
    "L137 no longer claims Section 12 ownership inside the Section 11 lesson range; L137/L138 legacy bodies are Optional enrichment",
  ],
});
...
defects.blockingSummary = "Stages 4-7 remain unaccepted. CIE wording, student mark-scheme presentation and the L049/L107/L121/L133 technical/image defects keep the release decision BLOCKED.";
...
const gateResult = {
  ...
  lessonIdentity: { stableLessonIds: 150, stableLessonUrls: 150, catalogueEntries: 150, optionalLegacyBodies: stage3OptionalBaseLessons.length },
...
- ${questionRegister.optionalCount} legacy lesson questions are explicitly Optional enrichment after CORE relocation; Stage 4 still must review all 963 prompts and mark schemes against official wording and answer boundaries.
