...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "B1", text: "describes how that method works" },
      { mark: "B1", text: "gives a valid advantage linked to that method" },
      { mark: "B1", text: "identifies a second distinct valid changeover method" },
      { mark: "B1", text: "describes how the second method works" },
      { mark: "B1", text: "gives a valid advantage linked to the second method" },
    ],
    strict: [
