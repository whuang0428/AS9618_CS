...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "A1", text: "gives a suitable normal example such as 50" },
      { mark: "B1", text: "defines boundary data as at the edge of the valid range" },
      { mark: "A1", text: "gives a suitable boundary example such as 0 or 100" },
      { mark: "B1", text: "defines erroneous data as invalid data that should be rejected" },
      { mark: "A1", text: "gives a suitable erroneous example such as -1, 101 or wrong type data" },
    ],
    strict: [
      ...
      "FT: if candidate uses a different but clear inclusive range, mark examples against that stated range.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: expected results can follow candidate's own stated validation rule if it is clear.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "A1", text: "states 0 and 100 should be accepted" },
      { mark: "B1", text: "identifies -1 and/or 101 as just outside the range" },
      { mark: "A1", text: "states -1 and 101 should be rejected" },
      { mark: "M1", text: "explains that boundary testing can reveal incorrect comparison logic" },
    ],
    strict: [
      ...
      "FT: if one boundary is misidentified, credit remaining correct reasoning where possible.",
    ],
  },
  {
    title: "Question 4",
    ...
    answer: "Examples: 50 gives Accepted; 0 gives Accepted; 100 gives Accepted; -1 gives Rejected; 101 gives Rejected; \"abc\" should be Rejected or handled as invalid input.",
    marking: [
      { mark: "B1", text: "includes a normal valid value with Accepted" },
      { mark: "B1", text: "includes lower boundary 0 with Accepted" },
      { mark: "B1", text: "includes upper boundary 100 with Accepted" },
      { mark: "B1", text: "includes a below-range value with Rejected" },
      { mark: "B1", text: "includes an above-range value with Rejected" },
      { mark: "M1", text: "uses expected outputs that match the given condition" },
    ],
    strict: [
      "maximum four value marks if expected outputs are absent.",
      "Allow any valid normal value from 1 to 99.",
      "Do not accept 0 as rejected for the given condition.",
      "FT: if candidate gives more than four tests, mark the best four unless contradictory expected results are given.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      { mark: "B1", text: "identifies that the existing values are only normal data" },
      { mark: "B1", text: "identifies missing boundary data" },
      { mark: "B1", text: "identifies missing erroneous/invalid data" },
      { mark: "A1", text: "adds valid boundary examples 0 and/or 100" },
      { mark: "A1", text: "adds erroneous out-of-range examples such as -1 and/or 101" },
      { mark: "M1", text: "explains that improved tests make faults more likely to be found" },
    ],
    strict: [
      ...
      "FT: weakness marks can be awarded even if the improved set is partly incomplete.",
    ],
  },
];
