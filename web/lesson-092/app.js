...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "A1", text: "explains allocating CPU time / managing multitasking" },
      { mark: "B1", text: "names memory management" },
      { mark: "A1", text: "explains allocating/protecting memory for programs" },
      { mark: "M1", text: "applies to several applications running" },
    ],
    strict: [
      ...
      "FT: application mark can follow from any two valid OS roles.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "compiled program produces object/executable code" },
      { mark: "M1", text: "interpreted code needs interpreter at run time / useful for debugging" },
      { mark: "A1", text: "answer is comparative rather than two isolated descriptions" },
    ],
    strict: [
      ...
      "FT: comparison mark can follow from mostly correct descriptions.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "A1", text: "links permissions to authorised staff / reducing unauthorised viewing" },
      { mark: "B1", text: "names encryption or authentication/MFA" },
      { mark: "A1", text: "explains mechanism of second control" },
      { mark: "M1", text: "applies to confidentiality of student records" },
    ],
    strict: [
      ...
      "FT: application mark can follow from any two valid controls.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "blocks unauthorised/suspicious traffic" },
      { mark: "A1", text: "applies to protecting a network" },
    ...
    strict: [
      ...
      "FT: protection mark can follow from a correct filtering mechanism.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "explicitly contrasts reversible encryption with one-way hashing" },
      { mark: "A1", text: "explains why the original statement is vague/incorrect" },
    ],
    strict: [
      ...
      "FT: final contrast mark can follow from correct explanations even if examples are weak.",
    ],
  },
];
