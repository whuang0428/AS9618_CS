...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "B1", text: "describes comparison/selection using 50" },
      { mark: "B1", text: "identifies 50 or 49/50 as boundary test data" },
      { mark: "B1", text: "explains expected boundary outcome" },
    ],
    strict: [
  ...
  },
  {
    ...
    marking: [
      ...
      { mark: "B1", text: "initialises and updates running total" },
      { mark: "B1", text: "calculates average by dividing total by 5" },
      { mark: "B1", text: "orders steps logically and outputs the result" },
    ],
    strict: [
  ...
  },
  {
    ...
    marking: [
      ...
      { mark: "B1", text: "explains -1 must not be processed/added" },
      { mark: "B1", text: "describes checking sentinel before adding or equivalent safe logic" },
    ],
    strict: [
  ...
  },
  {
    ...
    marking: [
      ...
      { mark: "B1", text: "gives one valid Cambridge convention such as INPUT, OUTPUT or assignment arrow" },
      { mark: "B1", text: "gives a second distinct convention such as IF...THEN...ELSE...ENDIF or FOR...NEXT" },
    ],
    strict: [
