...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "FT: loop bounds can follow from candidate's declared bounds.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: later totals may follow from one arithmetic slip if method is consistent.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "identifies row 4 is outside the declared bounds" },
      { mark: "A1", text: "states Grid[4, 2] does not refer to a valid cell" },
      { mark: "B1", text: "recognises column 2 itself is valid" },
      { mark: "A1", text: "links invalid access to row/column bounds" },
    ],
    strict: [
  ...
  },
  {
    ...
    strict: [
      ...
      "FT: final output can follow from candidate's row-total variable.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "identifies one index is insufficient" },
      { mark: "A1", text: "explains the column is missing / cell not identified" },
      { mark: "B1", text: "gives corrected access Marks[Row, Column]" },
      { mark: "M1", text: "places correction inside the inner loop / every cell processed" },
      { mark: "A1", text: "explains corrected statement adds each cell to Total" },
    ],
    strict: [
      ...
      "FT: explanation can follow from candidate's valid two-index correction.",
    ],
  },
];
