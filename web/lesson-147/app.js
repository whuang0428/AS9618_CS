...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "FT: if one earlier arithmetic error occurs, credit later method using candidate's running total.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "A1", text: "justifies stack using last-in, first-out or most recent first" },
      { mark: "B1", text: "chooses queue for printer jobs" },
      { mark: "A1", text: "justifies queue using first-in, first-out" },
      { mark: "B1", text: "chooses record for student data" },
      { mark: "A1", text: "justifies record using related fields of different types" },
    ],
    strict: [
      ...
      "FT: each structure choice is marked independently.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "A1", text: "normal data has correct expected result" },
      { mark: "B1", text: "gives valid boundary value such as 0 or 100" },
      { mark: "A1", text: "boundary valid value has correct expected result" },
      { mark: "B1", text: "gives invalid boundary or abnormal value such as -1, 101 or text" },
      { mark: "A1", text: "invalid or abnormal data has correct expected rejection/error result" },
      { mark: "M1", text: "answers are linked to inclusive range 0 to 100" },
    ],
    strict: [
      ...
      "FT: if the candidate uses a stated different range, credit consistent boundary logic only where explicit.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      { mark: "M1", text: "initialises Largest to a valid array element" },
      { mark: "M1", text: "loops through array elements" },
      { mark: "M1", text: "compares current element with Largest" },
      { mark: "A1", text: "updates Largest when current element is greater" },
      { mark: "M1", text: "continues until all relevant elements checked" },
      { mark: "A1", text: "outputs or returns Largest" },
    ],
    strict: [
      ...
      "FT: credit loop and output method if an initialisation error is made but logic is otherwise clear.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "states values are recorded step by step or per iteration" },
      { mark: "A1", text: "links trace to finding logic errors" },
      { mark: "A1", text: "gives valid example such as wrong condition, loop bound or update" },
      { mark: "M1", text: "links trace table to checking final output" },
      { mark: "A1", text: "explains evidence/method can be reviewed by programmer or examiner" },
    ],
    strict: [
      ...
      "FT: credit any valid logic-error example tied to changing variable values.",
    ],
  },
];
