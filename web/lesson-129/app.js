...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "FT: output-after-loop mark can follow candidate's equivalent success message.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: bound marks can follow candidate's equivalent variable name.",
    ],
  },
  {
    title: "Question 3",
    ...
    strict: [
      ...
      "FT: final output can follow a consistent trace if sentinel handling is clear.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "A1", text: "states WHILE may run zero times" },
      { mark: "B1", text: "states REPEAT...UNTIL body runs before condition is checked" },
      { mark: "A1", text: "states REPEAT...UNTIL runs at least once" },
      { mark: "B1", text: "uses accurate loop terminology such as condition-controlled or iteration" },
      { mark: "A1", text: "gives a suitable use case such as validation or unknown repetition count" },
    ],
    strict: [
      ...
      "FT: use-case mark can follow a correct description of either loop.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      { mark: "B1", text: "identifies the loop condition depends on a variable" },
      { mark: "M1", text: "explains the variable is not changed/updated in the loop body" },
      { mark: "A1", text: "states this can cause an infinite loop" },
      { mark: "M1", text: "gives a correction that updates or re-inputs the variable inside the loop" },
      { mark: "A1", text: "places the update before the next condition check / before ENDWHILE" },
      { mark: "B1", text: "uses accurate condition-controlled loop terminology" },
    ],
    strict: [
      ...
      "FT: correction marks can follow candidate's equivalent variable name.",
    ],
  },
];
