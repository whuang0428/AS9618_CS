...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "FT: if the candidate chooses a different measurable target, credit it if testable and scenario-linked.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "test cases are clearly linked to the capacity rule" },
    ],
    strict: [
      ...
      "FT: credit consistent tests if candidate states a different capacity clearly.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "A1", text: "explains algorithm use in implementation or testing" },
      { mark: "B1", text: "mentions data dictionary or field definitions" },
      { mark: "A1", text: "explains data definitions/types/validation in context" },
      { mark: "B1", text: "mentions interface design or user messages" },
      { mark: "A1", text: "links design documentation to implementation or testing evidence" },
    ],
    strict: [
      ...
      "FT: credit other relevant design documents if linked to the waiting-list feature.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "A1", text: "justifies corrective as fixing an error/fault" },
      { mark: "B1", text: "classifies new timetable structure as adaptive" },
      { mark: "A1", text: "justifies adaptive as responding to changed environment/rules" },
      { mark: "B1", text: "classifies faster search as perfective" },
      { mark: "A1", text: "justifies perfective as improving performance/usability/features" },
    ],
    strict: [
      ...
      "FT: each item is marked independently.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      { mark: "M1", text: "compares 92% with the 90% target" },
      { mark: "A1", text: "states the criterion is met" },
      { mark: "B1", text: "uses evidence to support an evaluation judgement" },
      { mark: "M1", text: "recognises remaining users or limitations" },
      { mark: "A1", text: "suggests a valid follow-up action such as feedback/log review" },
      { mark: "A1", text: "links follow-up to maintenance or improvement" },
    ],
    strict: [
      ...
      "FT: if candidate misreads the percentage but makes a consistent evidence-based judgement, credit remaining valid reasoning where possible.",
    ],
  },
];
