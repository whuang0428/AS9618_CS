...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "B1", text: "uses consistent index/variable names" },
    ...
    strict: [
      ...
      "FT: counter name and index name may vary if used consistently.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: flag names may vary if logic is clear.",
    ],
  },
  {
    title: "Question 3",
    ...
    strict: [
      ...
      "FT: output mark can follow candidate's read variable.",
    ],
  },
  {
    title: "Question 4",
    ...
    answer: "The value of Total is undefined before it is used, so the final total may be wrong. Add Total <- 0 before the loop, then update Total inside the loop and output or use it after the loop.",
    marking: [
      { mark: "B1", text: "identifies Total is not initialised" },
      { mark: "M1", text: "explains an undefined/previous value may affect the result" },
      { mark: "A1", text: "adds Total <- 0 before the loop" },
      { mark: "B1", text: "keeps Total update inside the loop" },
      { mark: "M1", text: "explains final value should be used after all iterations" },
      { mark: "A1", text: "uses Cambridge-style pseudocode notation in correction" },
    ],
    strict: [
      ...
      "FT: update reasoning may follow candidate's variable name.",
    ],
  },
  {
    title: "Question 5",
    ...
    answer: "Check that variables such as counters and totals are initialised before use. Check loop bounds and array indexes match the question. Check that selections, loops, files and subroutines are closed correctly, and that Java syntax has not replaced Cambridge pseudocode.",
    marking: [
      { mark: "B1", text: "checks initialisation of counters/totals/variables" },
      { mark: "B1", text: "checks loop bounds match the question" },
      { mark: "B1", text: "checks array indexes are consistent" },
      { mark: "B1", text: "checks constructs are closed correctly such as ENDIF/NEXT/CLOSEFILE" },
      { mark: "B1", text: "checks output/result is produced in the correct place" },
      { mark: "A1", text: "checks Cambridge pseudocode style and avoids Java-only syntax" },
    ],
    strict: [
      "accept any three developed checks for up to six marks when each includes a purpose.",
      ...
      "FT: checks may be scenario-specific if relevant.",
    ],
  },
];
