...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "open-source point linked to school scenario" },
      ...
      { mark: "M1", text: "proprietary drawback such as subscription cost/vendor lock-in/less control" },
      { mark: "A1", text: "balanced judgement linked to budget/skills/support needs" },
    ],
    strict: [
      "Do not accept 'open source is free' without qualification.",
      "Do not award balanced judgement for choosing one side with no trade-off.",
      "Allow hosted open-source support if the support arrangement is clear.",
      "FT: award judgement if it follows valid earlier points.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "condition such as attribution/notices/share-alike/warranty limitation" },
      { mark: "M1", text: "licence breach/loss of permission if conditions ignored" },
      { mark: "A1", text: "clear consequence or scenario link to compliance responsibility" },
    ],
    strict: [
      "Do not accept 'open source means no copyright'.",
      "Do not award condition mark for only saying 'rules'.",
      "Allow license spelling.",
      "FT: award consequence if licence obligations are implied.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "benefit linked to critical hospital/patient system" },
      ...
      { mark: "M1", text: "open-source risk such as maintenance/support/security update responsibility" },
      { mark: "A1", text: "balanced judgement based on support/reliability/risk" },
    ],
    strict: [
      ...
      "FT: judgement can choose either option if risk and support are evaluated.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "A1", text: "at least one point explained with consequence rather than label only" },
    ],
    strict: [
      ...
      "FT: explanation mark may attach to any valid advantage or disadvantage.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "inspection linked to reproducibility/transparency of research" },
      { mark: "B1", text: "modification/testing by others identified" },
      { mark: "B1", text: "licence choice/compliance responsibility" },
      { mark: "M1", text: "specific obligation such as attribution/notices/redistribution/share-alike" },
      { mark: "A1", text: "maintenance/documentation/support/security responsibility linked to users" },
    ],
    strict: [
      ...
      "FT: award responsibility marks independently of the suitability argument.",
    ],
  },
];
