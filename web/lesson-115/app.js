...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "FT: input loop bounds can follow from candidate's declared valid bounds.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: later totals may follow from one arithmetic slip if the method is consistent.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "identifies 0 is outside the declared bounds" },
      { mark: "A1", text: "states Scores[0] does not refer to a valid element" },
      { mark: "B1", text: "uses correct terminology such as index/subscript" },
      { mark: "A1", text: "links error to declared array bounds" },
    ],
    strict: [
      ...
      "FT: explanation may follow from candidate's stated bounds if internally consistent.",
    ],
  },
  {
    title: "Question 4",
  ...
  },
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "identifies index 6 is outside the bounds" },
      { mark: "A1", text: "explains index 6 does not refer to an existing element" },
      { mark: "B1", text: "gives corrected loop FOR Index <- 1 TO 5" },
      { mark: "M1", text: "states corrected loop processes all valid elements" },
      { mark: "A1", text: "states corrected loop avoids out-of-range access" },
    ],
    strict: [
      ...
      "FT: correction can follow from candidate's clearly stated valid bounds.",
    ],
  },
];
