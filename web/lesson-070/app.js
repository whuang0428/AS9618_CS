...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "frequency linked to data changes or acceptable data loss/RPO" },
      { mark: "B1", text: "location/offsite/isolated backup considered" },
      { mark: "M1", text: "location linked to site disaster/ransomware/theft/hardware failure" },
      { mark: "A1", text: "additional valid factor such as retention/security/testing restore" },
    ],
    strict: [
      ...
      "FT: award additional factor independently.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "full backup uses more time/storage or simpler restore" },
      { mark: "B1", text: "incremental backup copies changes since previous backup" },
      { mark: "M1", text: "incremental uses less time/storage" },
      { mark: "A1", text: "incremental restore complexity/needs chain/part missing risk" },
    ],
    strict: [
      ...
      "FT: award restore-complexity mark if full/incremental roles are clear.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "critical systems or recovery order identified" },
      { mark: "B1", text: "roles/responsibilities or communication described" },
      { mark: "M1", text: "restore from backup described" },
      { mark: "B1", text: "testing/checking restored data/system described" },
      { mark: "A1", text: "consequence linked to reduced downtime/availability/organised response" },
    ],
    strict: [
      ...
      "FT: award availability consequence if recovery actions are clear.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "used to identify who/when/what changed" },
      { mark: "M1", text: "used for investigation/accountability/evidence/misuse detection" },
      { mark: "A1", text: "limitation or link to backup for restoration" },
    ],
    strict: [
      ...
      "FT: award use marks if recorded items are partly implied.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "reason linked to ransomware not reaching/encrypting all copies" },
      { mark: "B1", text: "frequency or RPO linked to acceptable data loss" },
      { mark: "M1", text: "retention/versioning to restore clean pre-infection copy" },
      { mark: "B1", text: "restore testing/verify restored data described" },
      { mark: "A1", text: "DR response action such as isolate infected systems/clean restore/communication" },
    ],
    strict: [
      ...
      "FT: award each measure independently.",
    ],
  },
];
