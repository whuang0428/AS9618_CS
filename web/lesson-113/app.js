...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "A1", text: "reason states Score is whole number / used as whole-number mark" },
      { mark: "B1", text: "chooses REAL for AverageScore" },
      { mark: "A1", text: "reason states average may include decimal/fractional part" },
      { mark: "B1", text: "chooses BOOLEAN for Passed" },
      { mark: "A1", text: "reason states only two states such as TRUE/FALSE or pass/fail" },
    ],
    strict: [
      ...
      "FT: reason may follow candidate's type if technically coherent.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "identifies product code contains a letter" },
      { mark: "M1", text: "identifies leading zeroes must be preserved" },
      { mark: "A1", text: "states arithmetic is not required / it is an identifier" },
      { mark: "A1", text: "explains INTEGER would be unsuitable due to losing zeroes or not storing A" },
    ],
    strict: [
      ...
      "FT: unsuitability explanation can follow from either leading zero or letter point.",
    ],
  },
  {
    title: "Question 3",
  ...
  },
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "declares a variable using the new type" },
      { mark: "A1", text: "uses a clear type name and variable name for the scenario" },
    ],
    strict: [
      ...
      "FT: variable declaration can follow from candidate's valid user-defined type name.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "links DATE to comparison of dates" },
      { mark: "M1", text: "links DATE to validation or range checking" },
      { mark: "A1", text: "explains reduced ambiguity/error compared with free text" },
      { mark: "A1", text: "gives a balanced evaluation rather than a one-word answer" },
    ],
    strict: [
      ...
      "FT: balanced evaluation may follow from candidate's valid operation example.",
    ],
  },
];
