...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "A1", text: "applies benefit to school/staff/students" },
      { mark: "B1", text: "identifies privacy/biometric data/consent concern" },
      { mark: "A1", text: "explains consequence such as misuse, monitoring or unfair treatment" },
      { mark: "M1", text: "gives suitable safeguard such as consent, access control, retention limit or alternative method" },
      { mark: "A1", text: "balanced judgement linked to proportionality or conditions" },
    ],
    strict: [
      ...
      "FT: judgement mark can follow from valid benefit/concern even if safeguard is brief.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "condition applied to number of installations/users/computers" },
      { mark: "A1", text: "explains breach/infringement when copied beyond permission" },
    ...
    strict: [
      ...
      "FT: consequence can follow from correctly identified licence breach.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "uses suitable primary key such as CustomerID/ProductID" },
      { mark: "M1", text: "uses foreign keys in Purchase to link related tables" },
    ...
    strict: [
      ...
      "FT: key marks can follow from any sensible table names.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "A1", text: "complete grouped aggregate query with correct field/table use" },
    ],
    strict: [
      ...
      "FT: final mark can follow from minor syntax errors if grouping and aggregate intent are clear.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "A1", text: "valid scenario example such as presence/type/range check" },
      { mark: "B1", text: "defines verification as checking against source/original data" },
      { mark: "A1", text: "valid scenario example such as proofreading/double entry against form" },
      { mark: "M1", text: "contrasts validation cannot prove truth with verification checking copying accuracy" },
      { mark: "A1", text: "applies explanation to customer details/database entry" },
    ],
    strict: [
      ...
      "FT: contrast mark can follow from correct definitions even if examples are weak.",
    ],
  },
];
