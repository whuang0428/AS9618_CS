...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "recognises there are many values of the same type" },
      { mark: "M1", text: "explains indexed access/traversal" },
      { mark: "A1", text: "links traversal to total/average calculation" },
      { mark: "A1", text: "gives suitable declaration or equivalent clear structure" },
    ],
    strict: [
      ...
      "FT: declaration mark can follow candidate's chosen array name and bounds.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "states one record represents one book" },
      { mark: "M1", text: "states fields have names / meanings" },
      { mark: "A1", text: "recognises fields may have different data types" },
      { mark: "M1", text: "states array stores many book records" },
      { mark: "A1", text: "explains advantage over separate arrays: related data kept together / avoids mismatch" },
    ],
    strict: [
      ...
      "FT: field-reason marks can follow candidate's equivalent book fields.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "states data must persist after program ends" },
      { mark: "A1", text: "links persistence to being read next week" },
      { mark: "B1", text: "chooses APPEND mode for adding one new event" },
      { mark: "A1", text: "states existing log entries are not deleted / new entry added to end" },
    ],
    strict: [
      ...
      "FT: append reason can follow candidate's chosen log file name.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "states LIFO / most recent action undone first" },
      { mark: "B1", text: "uses PUSH for adding an action" },
      { mark: "B1", text: "uses POP for undo/removing most recent action" },
      { mark: "A1", text: "links popped action to reversal/undo" },
      { mark: "A1", text: "mentions empty-stack / underflow check" },
    ],
    strict: [
      ...
      "FT: operation marks can follow candidate's correct stack choice.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "states FIFO / first submitted printed first" },
      { mark: "B1", text: "uses ENQUEUE at rear for new jobs" },
      { mark: "B1", text: "uses DEQUEUE from front for processing jobs" },
      { mark: "M1", text: "identifies stack as LIFO" },
      { mark: "A1", text: "explains stack would process most recent job before earlier jobs" },
      { mark: "A1", text: "links unsuitability to not matching arrival order/fairness" },
    ],
    strict: [
      ...
      "FT: stack-unsuitable marks can follow candidate's correct LIFO explanation.",
    ],
  },
];
