...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "valid OS role such as process, memory, file or device management" },
      { mark: "B1", text: "utility software identified as specific maintenance/protection/support task" },
      { mark: "M1", text: "valid utility example and mechanism, e.g. backup restores copies / antivirus scans malware" },
      { mark: "B1", text: "clear distinction between general OS role and narrower utility role" },
      { mark: "A1", text: "scenario consequence or second valid example explained" },
    ],
    strict: [
      ...
      "FT: award example marks independently if the comparison wording is weak.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "compiler translates whole program before execution / produces object or executable code" },
      { mark: "A1", text: "distribution benefit such as source code not needed or repeated execution without retranslation" },
    ],
    strict: [
      ...
      "FT: award each stage independently if one stage choice is incorrect.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "valid token examples such as identifiers, keywords, operators or literals" },
      ...
      { mark: "A1", text: "valid semantic example such as type compatibility/declaration/scope or symbol table use" },
    ],
    strict: [
      ...
      "FT: award each stage mark independently.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "linker resolves external references/library routine references" },
      ...
      { mark: "M1", text: "loader may relocate/adjust addresses or allocate memory" },
      { mark: "A1", text: "program prepared for execution / processor can execute" },
    ],
    strict: [
      ...
      "FT: award linker and loader portions independently.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "syntax justification linked to grammar/structure" },
      { mark: "B1", text: "wrong average classified as logic" },
      { mark: "M1", text: "logic justification linked to runs/completes but wrong result/algorithm" },
      { mark: "B1", text: "file not found while running classified as runtime" },
      { mark: "A1", text: "runtime justification linked to failure during execution/external resource" },
    ],
    strict: [
