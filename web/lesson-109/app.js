...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "linear worst case may check all 100 items" },
      { mark: "B1", text: "binary search requires sorted data / sorted list condition recognised" },
      { mark: "M1", text: "binary search compares with middle value / halves search area" },
      { mark: "A1", text: "explains binary search usually uses fewer comparisons for this sorted large list" },
      { mark: "A1", text: "gives a clear comparison rather than two unrelated definitions" },
    ],
    strict: [
      ...
      "FT: comparison mark can follow from candidate's valid search descriptions.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains inner loop runs for each row" },
      { mark: "M1", text: "uses multiplication rather than addition" },
      { mark: "A1", text: "calculates 12 x 5" },
      { mark: "A1", text: "final answer 60 executions" },
    ],
    strict: [
      ...
      "FT: final answer can follow from candidate's multiplication method.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "A1", text: "best case uses one comparison" },
      { mark: "B1", text: "worst case identified as target last or absent" },
      { mark: "A1", text: "worst case may check every item" },
      { mark: "M1", text: "links work to number of items / input size" },
      { mark: "A1", text: "clear linear search context" },
    ],
    strict: [
      "Do not accept best/worst labels without a search scenario.",
      "Allow 'not found' for absent target.",
      "Do not require average case.",
      "FT: comparison counts can follow from candidate's stated list size if given.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains items must be copied before or in addition to searching" },
      { mark: "B1", text: "identifies extra memory/space use" },
      { mark: "M1", text: "explains second list / copied data must be stored" },
      { mark: "A1", text: "links extra resource use to input size" },
      { mark: "A1", text: "gives relevant judgement such as unnecessary if direct search is possible" },
    ],
    strict: [
      ...
      "FT: judgement mark can follow from candidate's valid resource issue.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "linear search worst case may check each item once" },
      { mark: "B1", text: "bubble sort uses repeated passes / adjacent comparisons" },
      { mark: "M1", text: "explains bubble sort performs many comparisons to sort the whole list" },
      { mark: "A1", text: "clear evaluative conclusion that they are not equally efficient for that reason" },
    ],
    strict: [
      ...
      "FT: conclusion can follow from candidate's valid comparison of work done.",
    ],
  },
];
