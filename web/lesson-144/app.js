...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "A1", text: "describes algorithm design as processing logic or steps in the booking context" },
      { mark: "B1", text: "identifies data dictionary as a design document" },
      { mark: "A1", text: "describes data dictionary contents such as type, size, format or validation" },
      { mark: "B1", text: "identifies interface design / screen design as a design document" },
      { mark: "A1", text: "describes controls, navigation, prompts, messages or user interaction" },
    ],
    strict: [
      ...
      "FT: if a candidate uses a different school system context, credit relevant artefacts that fit that context.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "A1", text: "answers are scenario-specific and clearly presented as data dictionary entries" },
    ],
    strict: [
      ...
      "FT: validation marks may follow the candidate's chosen data type if technically consistent.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "A1", text: "explains implementation using fields, algorithms, interface behaviour or structure" },
      { mark: "B1", text: "states design documentation helps testing" },
      { mark: "A1", text: "explains testing by comparing actual behaviour with designed rules or expected results" },
      { mark: "B1", text: "states design documentation helps maintenance" },
      { mark: "A1", text: "explains maintenance using future understanding, safer changes or reduced faults" },
    ],
    strict: [
      ...
      "FT: credit valid consequences from weak documentation if linked to the stage.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "uses relevant fields such as RoomID, date and time interval" },
      { mark: "A1", text: "describes a reject/clash outcome from the algorithm" },
      { mark: "B1", text: "identifies a relevant interface feature such as availability check or disabled submit" },
      { mark: "M1", text: "describes user feedback such as a clear clash/error message" },
      { mark: "A1", text: "links interface behaviour to preventing the invalid booking before saving" },
    ],
    strict: [
      ...
      "FT: if the candidate's algorithm identifies clashes correctly, credit a matching interface response.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "A1", text: "improves it with concrete interface design details" },
      { mark: "B1", text: "identifies vague processing/checking as a weakness" },
      { mark: "A1", text: "improves it with algorithm design detail such as pseudocode or flowchart" },
      { mark: "B1", text: "identifies missing data definitions or validation as a weakness" },
      { mark: "A1", text: "improves it with data dictionary content" },
    ],
    strict: [
      ...
      "FT: credit reasonable improvements even if weakness wording differs.",
    ],
  },
];
