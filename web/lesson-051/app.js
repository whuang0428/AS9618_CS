...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "address from PC is copied to MAR / MAR holds address being accessed" },
      { mark: "B1", text: "read signal/address bus used to access memory" },
      { mark: "M1", text: "instruction/data fetched from memory into MDR" },
      { mark: "A1", text: "instruction copied to CIR for decoding" },
    ...
    strict: [
      ...
      "FT: award later register role marks if earlier bus wording is weak but sequence is clear.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "A1", text: "valid direct example such as memory[20] = 70 gives loaded value 70" },
      { mark: "B1", text: "indirect addressing uses operand as address of a pointer / address of an address" },
      { mark: "M1", text: "indirect example performs first lookup to get effective address" },
      { mark: "A1", text: "indirect example performs second lookup to get final value" },
    ],
    strict: [
      ...
      "FT: award example marks if candidate's memory values are different but method is consistent.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "processor state saved, with valid examples such as PC/registers/flags" },
      ...
      { mark: "A1", text: "state restored and interrupted program resumes" },
    ],
    strict: [
      ...
      "FT: award resume mark if state saving has been described.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "mechanism for first factor explained" },
      { mark: "A1", text: "valid limitation/condition for first factor" },
      { mark: "B1", text: "second valid factor identified" },
      { mark: "M1", text: "mechanism for second factor explained" },
      { mark: "A1", text: "valid limitation/condition for second factor" },
    ],
    strict: [
      "Do not accept factor names alone without mechanism for M marks.",
      "Do not accept 'it is better' as a limitation or consequence.",
      "Allow any two valid Section 4 performance factors.",
      "FT: if more than two factors are given, mark the best two complete explanations.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "valid fetch/decode/execute overlap example" },
      { mark: "A1", text: "throughput can increase / instructions complete more frequently" },
      { mark: "B1", text: "branch may change PC / next instruction address" },
      { mark: "M1", text: "wrong instructions may already have been fetched" },
      { mark: "A1", text: "flush/stall/delay reduces ideal performance gain" },
    ],
    strict: [
      ...
      "FT: award limitation mark if candidate clearly describes discarded instructions even without word 'flush'.",
    ],
  },
];
