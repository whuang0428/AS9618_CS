...
const examQuestions = [
  ...
  },
  {
    title: "Question 2",
    marks: "5 marks",
    prompt: "Compare IPv4 with IPv6 and explain the purpose of subnetting.",
    answer: "IPv4 uses 32-bit addresses, whereas IPv6 uses 128-bit addresses and therefore provides a much larger address space. Subnetting divides a network into smaller logical subnetworks by using part of the IP address to identify the network or subnet. This can organise addressing and limit the scope of local traffic.",
    marking: [
      { mark: "B1", text: "IPv4 uses 32-bit addresses" },
      { mark: "B1", text: "IPv6 uses 128-bit addresses" },
      { mark: "B1", text: "IPv6 provides a much larger address space" },
      { mark: "B1", text: "subnetting divides a network into smaller logical subnetworks" },
      { mark: "B1", text: "part of the address identifies the network/subnet or a valid organisation/local-traffic consequence" },
    ],
    strict: [
      "Do not reverse the 32-bit and 128-bit address lengths.",
      "Do not accept that subnetting creates a separate internet.",
      "Do not require candidates to calculate a subnet mask unless the question supplies one.",
    ],
  },
  {
    title: "Question 3",
