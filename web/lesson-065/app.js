...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "valid authentication credential example, e.g. password/biometric/token" },
      { mark: "B1", text: "authorisation controls permitted access/actions/resources" },
      { mark: "M1", text: "authorisation occurs after or depends on authentication" },
      { mark: "A1", text: "clear scenario example distinguishing identity from permissions" },
    ],
    strict: [
      ...
      "FT: award example mark if the distinction is clear even with weak terminology.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "password advantage such as cheap/familiar/easy to implement/change" },
      { mark: "M1", text: "password limitation such as guessed/reused/shared/phished/forgotten" },
      { mark: "B1", text: "biometric advantage such as convenient/not forgotten/hard to share casually" },
      { mark: "A1", text: "biometric limitation such as sensor/templates/privacy/false accept/false reject/cannot change" },
    ],
    strict: [
      ...
      "FT: award comparison marks independently for each method.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "valid example with different categories, e.g. password plus token/biometric" },
      { mark: "B1", text: "stolen/guessed password alone is insufficient" },
      { mark: "M1", text: "risk of unauthorised access/account takeover is reduced" },
      { mark: "A1", text: "valid limitation or residual risk described" },
    ],
    strict: [
      ...
      "FT: award risk-reduction mark if factor wording is weak but second independent evidence is clear.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "token use described, e.g. one-time code/insert/tap/registered device" },
      ...
      { mark: "A1", text: "second distinct limitation or support/recovery issue" },
    ],
    strict: [
      ...
      "FT: award MFA mark if password plus token is clearly described.",
    ],
  },
  {
    title: "Question 5",
