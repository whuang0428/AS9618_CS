...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "A1", text: "states values below 0 or above 100 should be rejected" },
      { mark: "B1", text: "identifies type check or equivalent for integer input" },
      { mark: "M1", text: "explains invalid data is prevented from being processed" },
      { mark: "A1", text: "links validation to robustness, reliability or suitable user feedback" },
    ],
    strict: [
      ...
      "FT: if candidate uses a different stated valid range, mark consequences against that range.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: return marks can follow candidate's consistent but partly flawed condition.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "A1", text: "gives at least two suitable module examples" },
      { mark: "M1", text: "explains each module can have one clear responsibility" },
      ...
      { mark: "A1", text: "states modules can be reused or maintained/changed independently" },
    ],
    strict: [
      ...
      "FT: benefits can follow any sensible program decomposition.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "A1", text: "gives suitable validation example" },
      { mark: "B1", text: "defines verification as checking data has been accurately entered/copied" },
      { mark: "A1", text: "gives suitable verification example" },
      { mark: "M1", text: "clearly distinguishes acceptable data from accurately copied data" },
      { mark: "A1", text: "uses examples that match the definitions" },
    ],
    strict: [
      ...
      "FT: examples may be credited if the candidate's definitions are clear enough.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains this avoids repeated or inconsistent validation code" },
      { mark: "B1", text: "states the function can be tested separately" },
      { mark: "A1", text: "links testing to normal/boundary/erroneous data or fault detection" },
      { mark: "A1", text: "explains a change to the rule can be made in one place" },
    ],
    strict: [
      ...
      "FT: benefits can follow equivalent module names such as CheckMarkRange.",
    ],
  },
];
