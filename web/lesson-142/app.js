...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "FT: examples can follow a candidate's stated school booking context.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains waterfall suits stable requirements" },
      { mark: "A1", text: "explains late changes can cause costly rework in waterfall" },
      { mark: "B1", text: "states iterative development uses repeated cycles" },
      { mark: "M1", text: "explains feedback can refine requirements" },
      { mark: "A1", text: "selects iterative as more suitable for changing/uncertain requirements with reason" },
    ],
    strict: [
      ...
      "FT: suitability mark can follow candidate's scenario if reason is coherent.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "links weak analysis to poor design or wrong implementation" },
      { mark: "M1", text: "links later testing/evaluation to discovering the problem" },
      { mark: "A1", text: "explains consequence such as rework, delay, cost or unsuitable system" },
    ],
    strict: [
      ...
      "FT: later-stage consequences can follow any valid missed requirement.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "A1", text: "explains it states what the system must do" },
      { mark: "B1", text: "names design specification or equivalent" },
      { mark: "A1", text: "explains it guides implementation/design decisions" },
      { mark: "B1", text: "names test plan/results or equivalent" },
      { mark: "A1", text: "explains it records tests/results or compares actual with expected" },
    ],
    strict: [
      ...
      "FT: use marks can follow alternative valid artefacts.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains evaluation checks objectives/user requirements" },
      { mark: "B1", text: "states maintenance can happen after release/use" },
      { mark: "A1", text: "gives valid maintenance type/example such as corrective/adaptive/perfective" },
      { mark: "M1", text: "explains feedback may send project back to earlier stages" },
      { mark: "A1", text: "links feedback to design/implementation/requirements rework" },
    ],
    strict: [
      ...
      "FT: feedback stage may vary if the explanation is coherent.",
    ],
  },
];
