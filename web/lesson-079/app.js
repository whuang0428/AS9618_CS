...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "flat-file linked to repeated data/redundancy" },
      { mark: "A1", text: "relational linked to reduced redundancy or improved consistency" },
    ],
    strict: [
      ...
      "FT: if the structure distinction is valid, award consequence marks for matching effects.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "redundancy explained in club context" },
      { mark: "B1", text: "risk of inconsistent data or update anomaly" },
      { mark: "M1", text: "relational linked tables/store shared data once" },
      { mark: "A1", text: "clear consequence such as easier updates/improved consistency/maintainability" },
    ],
    strict: [
      ...
      "FT: consistency mark can follow any valid repeated-data example.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "advantage linked to small one-off school trip context" },
      { mark: "B1", text: "disadvantage such as repeated data/redundancy/inconsistency" },
      { mark: "M1", text: "disadvantage linked to contact/medical/student detail updates" },
      { mark: "A1", text: "balanced judgement or suitability condition" },
    ],
    strict: [
      ...
      "FT: judgement may support or reject flat-file if both sides are explained.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "redundancy explained with related data repeated across rows" },
      { mark: "B1", text: "update anomaly/inconsistency identified" },
      { mark: "M1", text: "update problem explained as some copies changed and others not" },
      { mark: "B1", text: "insertion or deletion anomaly identified" },
      { mark: "M1", text: "insertion/deletion problem explained with loss or inability to store a separate fact" },
    ],
    strict: [
      ...
      "FT: an anomaly can be credited without the formal name if the mechanism is clear.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains redundancy in online shop context" },
      { mark: "B1", text: "update/inconsistency problem from address changes" },
      { mark: "M1", text: "relational solution: customer details stored once and linked to orders" },
      { mark: "B1", text: "possible disadvantage/condition such as added complexity for very small data" },
      { mark: "A1", text: "balanced judgement based on size/growth/repetition" },
    ],
    strict: [
      ...
      "FT: final judgement may oppose change if the small-data condition is justified.",
    ],
  },
];
