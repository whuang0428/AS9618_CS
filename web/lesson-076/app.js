...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "benefit linked to meetings/commuting/business travel" },
      ...
      { mark: "M1", text: "social harm such as isolation/work-life boundary issue" },
      { mark: "A1", text: "balanced judgement or mitigation linked to scenario" },
    ],
    strict: [
      ...
      "FT: award mitigation if it follows a valid harm.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "environmental harm from toxic materials/pollution" },
      { mark: "M1", text: "environmental harm from manufacturing/resource/energy demand" },
      { mark: "B1", text: "reduction method such as repair/reuse/donation/longer lifespan" },
      { mark: "A1", text: "responsible recycling or reduction method linked to reduced harm" },
    ],
    strict: [
      ...
      "FT: award reduction marks even if definition is brief.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "benefit linked to workers or factory context" },
      { mark: "B1", text: "harm such as job loss/displacement" },
      { mark: "M1", text: "harm explained through retraining/deskilling/income impact" },
      { mark: "B1", text: "mitigation such as retraining/redeployment/support" },
      { mark: "A1", text: "balanced judgement about acceptability/transition planning" },
    ],
    strict: [
      "Do not accept 'robots are bad' without worker impact.",
      "Do not award balanced judgement for a one-sided answer.",
      "Allow dangerous task reduction as a worker benefit.",
      "FT: mitigation mark can be awarded if job-loss risk is implied.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "exclusion from online service explained" },
      { mark: "B1", text: "consequence such as reduced access to banking/healthcare/education/public services" },
      { mark: "A1", text: "mitigation such as assisted access/training/accessibility/alternative channel" },
    ],
    strict: [
      ...
      "FT: consequence mark can follow any valid exclusion point.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "benefit linked to textbooks/school materials" },
      ...
      { mark: "M1", text: "social harm such as distraction/home internet inequality/digital divide" },
      { mark: "B1", text: "mitigation such as repair/reuse/recycling/loan scheme/offline access/training" },
      { mark: "M1", text: "mitigation linked to a named harm" },
      { mark: "A1", text: "balanced judgement about conditions for positive impact" },
    ],
    strict: [
      ...
      "FT: judgement can be positive or negative if supported by balanced analysis.",
    ],
  },
];
