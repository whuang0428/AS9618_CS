...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "uses clear field declarations within the record" },
      { mark: "A1", text: "closes the record definition clearly, e.g. ENDTYPE" },
    ],
    strict: [
      ...
      "FT: syntax marks can follow from candidate's equivalent record notation.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "uses dot notation for Name field" },
      { mark: "A1", text: "assigns Ali to Student1.Name" },
      { mark: "M1", text: "uses dot notation for Mark field" },
      { mark: "A1", text: "assigns 72 to Student1.Mark" },
    ...
    strict: [
      ...
      "FT: output mark can follow candidate's record variable name.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "recognises fields have different meanings" },
      { mark: "M1", text: "recognises fields may have different data types" },
      { mark: "A1", text: "gives suitable example types for at least two fields" },
      { mark: "B1", text: "states record fields have meaningful names" },
      { mark: "A1", text: "contrasts with array as same-type/indexed structure" },
    ],
    strict: [
      ...
      "FT: examples can follow candidate's chosen patient fields.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "states records use field names/dot notation" },
      { mark: "A1", text: "explains numeric index is array-style access" },
      { mark: "B1", text: "gives corrected Student1.Name access" },
      { mark: "A1", text: "assigns Ali to the Name field" },
      { mark: "B1", text: "uses clear Cambridge-style assignment" },
    ],
    strict: [
      ...
      "FT: correction can follow candidate's record variable name.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "reason for ProductCode as identifier / not arithmetic" },
      { mark: "A1", text: "reason mentions preserving letters or leading zeroes" },
    ],
    strict: [
      ...
      "FT: reason marks can follow any candidate field used as product identifier.",
    ],
  },
];
