...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "identifies bit-to-byte conversion / divide by 8" },
      { mark: "A1", text: "final answer needs suitable unit" },
      { mark: "A1", text: "explains why this protects method/final marks" },
    ],
    strict: [
      "Do not award full credit for 'write more working' without specifying what working.",
      "Allow mention of FT marks for method evidence.",
      "Do not require a specific image size because values are not given.",
      "FT: final explanation mark can follow from any valid method/unit repair.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "compiled program/object code can run without retranslation" },
      { mark: "M1", text: "interpreter needs interpreter at run time or helps debugging" },
      { mark: "A1", text: "uses paired comparison wording" },
      { mark: "A1", text: "answer clearly repairs the weak original" },
    ],
    strict: [
      ...
      "FT: repair mark can follow from mostly correct paired contrasts.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "A1", text: "explains mechanism/consequence in school records context" },
      { mark: "B1", text: "names second valid control such as access rights" },
      { mark: "A1", text: "explains mechanism/consequence of second control" },
      { mark: "B1", text: "names third valid control such as encryption/backup/firewall" },
      { mark: "A1", text: "explains mechanism/consequence of third control" },
    ],
    strict: [
      ...
      "FT: explanation marks can follow from any valid named control.",
    ],
  },
  {
    title: "Question 4",
    ...
    strict: [
      ...
      "FT: explanation mark can follow from correct aggregate idea even with minor syntax error.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "A1", text: "applies benefit to public facial recognition" },
      { mark: "B1", text: "identifies privacy/surveillance/consent concern" },
      { mark: "A1", text: "explains privacy consequence such as monitoring/misuse/retention" },
      { mark: "B1", text: "identifies fairness/accuracy/biometric data concern or similar" },
      { mark: "M1", text: "gives safeguard such as transparency, access control or retention limit" },
      { mark: "A1", text: "balanced judgement linked to proportionality" },
      { mark: "A1", text: "clearly repairs the one-sided original answer" },
    ],
    strict: [
      ...
      "FT: judgement mark can follow from valid benefit/concern/safeguard.",
    ],
  },
];
