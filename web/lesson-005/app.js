...
const examQuestions = [
  {
    ...
    answer: "11101001₂",
    marking: [
      { mark: "M1", text: "writes +23 as 00010111" },
      { mark: "M1", text: "inverts bits to get 11101000" },
      { mark: "M1", text: "adds 1 to the inverted value" },
      { mark: "A1", text: "11101001" },
    ],
    strict: [
      "Do not award A1 for 11101000; that is one’s complement, not two’s complement.",
  ...
  },
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "uses a valid method, e.g. unsigned value 233 then 233 - 256, or invert and add 1" },
      { mark: "A1", text: "-23" },
    ],
    strict: [
      "Do not accept 233; that is the unsigned interpretation.",
      "Allow FT if a correct method is shown after one arithmetic slip.",
  ...
  },
  {
    ...
    answer: "Two’s complement has only one zero. 10000000₂ represents -128.",
    marking: [
