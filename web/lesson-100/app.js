...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "FT: if candidate uses valid alternative symbol names consistently, award where meaning is clear.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: output branch marks can follow from candidate's stated condition.",
    ],
  },
  {
    title: "Question 3",
    ...
    strict: [
      ...
      "FT: output mark can follow from candidate's running total variable.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "compares decision representation in both forms" },
      { mark: "M1", text: "recognises both can represent the same algorithm logic" },
      { mark: "A1", text: "uses accurate examples such as diamond vs IF...THEN...ELSE" },
    ],
    strict: [
      ...
      "FT: examples can follow from candidate's chosen algorithm structure.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "B1", text: "gives INPUT as a convention" },
      { mark: "B1", text: "gives OUTPUT as a convention" },
      { mark: "M1", text: "gives IF...THEN...ELSE...ENDIF or valid selection convention" },
      { mark: "A1", text: "gives loop convention or indentation/readability convention" },
    ],
    strict: [
