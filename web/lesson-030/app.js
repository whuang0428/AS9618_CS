...
const examQuestions = [
  ...
  },
  {
    title: "Question 4",
    marks: "6 marks",
    prompt: "Compare PROM, EPROM and EEPROM, including how each can be programmed or erased.",
    answer: "PROM is non-volatile memory that can be programmed once and is not erased for reuse. EPROM is non-volatile memory that can be erased using ultraviolet light and then reprogrammed. EEPROM is non-volatile memory that is erased and rewritten electrically, often while it remains installed in the system.",
    marking: [
      { mark: "B1", text: "PROM can be programmed once" },
      { mark: "B1", text: "PROM is not erased/reprogrammed for reuse" },
      { mark: "B1", text: "EPROM is erased using ultraviolet light" },
      { mark: "B1", text: "EPROM can then be reprogrammed" },
      { mark: "B1", text: "EEPROM is erased/rewritten electrically" },
      { mark: "B1", text: "EEPROM can often be rewritten while installed/in circuit" },
    ],
    strict: [
      "Do not confuse one-time PROM with UV-erasable EPROM.",
      "Do not claim EPROM is erased electrically.",
      "All three are non-volatile ROM technologies; do not describe them as ordinary RAM.",
    ],
  },
  {
    title: "Question 5",
