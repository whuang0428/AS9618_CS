...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "FT: later count values may follow from candidate's previous row if the update rule is consistent.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "A1", text: "uses clear Cambridge-style pseudocode rather than Java-only syntax" },
    ],
    strict: [
      ...
      "FT: output mark can follow from candidate's count variable name if consistent.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "loops through each character of the password" },
      { mark: "M1", text: "compares current character with #" },
      { mark: "A1", text: "sets Found to TRUE when # is found" },
      { mark: "B1", text: "does not reset Found to FALSE after it has become TRUE" },
      { mark: "A1", text: "outputs result after processing / based on Found" },
    ],
    strict: [
      ...
      "FT: final output can follow from candidate's flag name.",
    ],
  },
  {
    title: "Question 4",
    ...
    strict: [
      ...
      "FT: output mark can follow from candidate's constructed string variable.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains it can miss or shift characters in the trace" },
      { mark: "B1", text: "identifies Java-only syntax issue" },
      { mark: "M1", text: "explains Cambridge-style pseudocode should use clear keywords / assignment" },
      { mark: "A1", text: "uses a string-processing context, not generic Java criticism only" },
      { mark: "A1", text: "gives two distinct errors with consequences" },
    ],
    strict: [
      ...
      "FT: consequence marks can follow from candidate's valid identified errors.",
    ],
  },
];
