...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "combines the ideas as an array of records" },
      { mark: "A1", text: "explains that fields for one student are kept together" },
      { mark: "A1", text: "explains that the collection stores many students" },
      { mark: "B1", text: "uses the scenario fields StudentID, Name and Mark accurately" },
    ],
    strict: [
      ...
      "FT: justification marks can follow a candidate's suitable alternative data model if consistently explained.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: array declaration can follow the candidate's valid record type name.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "splits or separates the line into fields using commas" },
      { mark: "B1", text: "identifies ItemCode as text/string data" },
      { mark: "A1", text: "converts Quantity to INTEGER or numeric form" },
      { mark: "A1", text: "converts Price to REAL or numeric form" },
      { mark: "M1", text: "uses the converted numeric fields in the calculation" },
      { mark: "A1", text: "states that calculation should not use unconverted text values" },
    ],
    strict: [
      ...
      "FT: calculation mark can follow candidate's selected field positions if the method is consistent.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "A1", text: "states LIFO or Last In, First Out" },
      { mark: "M1", text: "uses PUSH/add operation for visited pages" },
      { mark: "M1", text: "uses POP/remove operation for the Back button" },
      { mark: "A1", text: "explains that the most recent page is returned first" },
      { mark: "B1", text: "applies the answer to browser history/back button scenario" },
    ],
    strict: [
      ...
      "FT: operation marks can follow a candidate's named stack-like structure.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "A1", text: "explains last item added is first removed" },
      { mark: "B1", text: "gives a suitable stack example such as undo/backtracking" },
      { mark: "B1", text: "states queue uses FIFO" },
      { mark: "A1", text: "explains first item added is first removed" },
    ...
    strict: [
      ...
      "FT: example marks can follow reversed labels only if the behaviour is internally consistent, but do not award the original label rule mark.",
    ],
  },
];
