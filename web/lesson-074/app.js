...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "public access is not the same as permission" },
      { mark: "B1", text: "licence/permission should be checked" },
      { mark: "M1", text: "licence condition such as commercial use/modification/redistribution/attribution explained" },
      { mark: "B1", text: "infringement/licence breach identified" },
      { mark: "A1", text: "consequence such as legal action/damages/removal/reputation linked to scenario" },
    ],
    strict: [
      ...
      "FT: award consequence if a valid breach is implied.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "copyright restricts copying/distribution/adaptation without permission" },
      { mark: "B1", text: "patent protects invention/technical process" },
      { mark: "M1", text: "patent is limited time and/or requires novelty/inventive step" },
      { mark: "A1", text: "Computer Science context or limitation, such as not every code idea is patentable" },
    ],
    strict: [
      ...
      "FT: award contrast marks where the distinction is clear even if terminology is imperfect.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "licence does not normally transfer ownership/source code rights" },
      { mark: "B1", text: "copyright/IP owner retains rights" },
      { mark: "M1", text: "restriction such as copying/modifying/redistributing/reverse engineering" },
      { mark: "A1", text: "consequence such as breach/infringement if restrictions are ignored" },
    ],
    strict: [
      ...
      "FT: award breach consequence if ownership distinction is implied.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "creator/owner rights recognised" },
      { mark: "M1", text: "investment/revenue/innovation consequence explained" },
      ...
      { mark: "A1", text: "scenario-style link to software use or user responsibility" },
    ],
    strict: [
      ...
      "FT: award legal and ethical marks independently.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "attribution/licence notice requirement explained" },
      { mark: "B1", text: "breach of licence or infringement identified" },
      { mark: "B1", text: "ownership/IP of original creators recognised" },
      { mark: "M1", text: "consequence such as loss of permission/legal action/replacement/reputational damage" },
      { mark: "A1", text: "remedy such as include attribution/notices or document components" },
    ],
    strict: [
      ...
      "FT: award remedy mark if it addresses the stated licence condition.",
    ],
  },
];
