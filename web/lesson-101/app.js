...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "FT: final output may follow from candidate's final Total.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: output can follow from candidate's final Highest.",
    ],
  },
  {
    title: "Question 3",
    ...
    strict: [
      ...
      "FT: output can follow from candidate's stated processing rule.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains locating the first incorrect variable/value" },
      { mark: "B1", text: "gives a valid logic-error example" },
      { mark: "A1", text: "explains correction/debugging benefit clearly" },
    ],
    strict: [
      ...
      "Do not require code.",
      "FT: debugging benefit can follow from candidate's valid example.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains loop iterations must finish before output" },
      { mark: "B1", text: "blank/dash output during loop rows" },
      { mark: "A1", text: "final output recorded once after loop" },
      { mark: "A1", text: "uses correct trace-table terminology" },
    ],
    strict: [
      ...
      "FT: final output placement can follow from candidate's stated loop structure.",
    ],
  },
];
