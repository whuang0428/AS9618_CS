...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "FT: award ORDER BY method mark if the selected fields contain a minor error but sorting by Price is clear.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "B1", text: "FROM Book" },
      { mark: "A1", text: "complete query that returns one count value" },
    ],
    strict: [
      ...
      "FT: FROM mark can be awarded if the aggregate expression has a minor syntax error.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "B1", text: "FROM Book" },
      { mark: "A1", text: "complete query returning one average value" },
    ],
    strict: [
      ...
      "FT: FROM mark may be awarded if the selected aggregate is wrong but the table is correct.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "A1", text: "complete grouped query producing one count for each Category" },
    ],
    strict: [
      ...
      "Allow COUNT(BookID) if BookID is a required non-null key field.",
      "FT: final answer mark can follow through from a valid alternative count field if grouping is correct.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "replaces or adds GROUP BY Category" },
      { mark: "B1", text: "retains SELECT Category, COUNT(*)" },
      { mark: "B1", text: "retains FROM Book" },
      { mark: "A1", text: "complete corrected query returns counts per Category" },
    ],
    strict: [
      ...
      "Do not require a semicolon.",
      "FT: complete query mark depends on GROUP BY being present and applied to Category.",
    ],
  },
];
