...
const examQuestions = [
  {
    ...
    strict: [
      ...
      "Allow FT from an incorrect bit total if division by 8 is shown.",
  ...
  },
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "interpreter useful for debugging or needs interpreter at run time" },
      { mark: "A1", text: "answer is comparative, with paired contrasts" },
    ],
    strict: [
      ...
      "FT: final comparison mark can follow from mostly correct paired points.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "A1", text: "explains encoded/unreadable without key" },
      { mark: "M1", text: "links encryption to confidentiality during transmission" },
      { mark: "B1", text: "names authentication/MFA or access rights" },
      { mark: "A1", text: "explains mechanism of second control" },
      { mark: "M1", text: "applies second control to reducing unauthorised access/risk" },
    ],
    strict: [
      ...
      "FT: application marks can follow from valid alternative controls.",
    ],
  },
  {
    title: "Question 4",
    ...
    strict: [
      ...
      "Allow COUNT(BookID).",
      "FT: final mark can follow from a minor syntax error if clause logic is correct.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "A1", text: "applies benefit to town/public spaces" },
      { mark: "B1", text: "valid concern such as privacy, surveillance or biometric data misuse" },
      { mark: "A1", text: "explains consequence of concern" },
      { mark: "M1", text: "gives suitable safeguard/condition such as retention limit, transparency or access control" },
    ...
    strict: [
      ...
      "FT: judgement mark can follow from a valid benefit and concern even if wording is brief.",
    ],
  },
];
