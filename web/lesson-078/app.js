...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "school attendance data example, such as student ID/date/attendance mark" },
      { mark: "A1", text: "processed information example, such as absence rate/list of repeated absences" },
    ],
    strict: [
      ...
      "FT: if the data example is valid, allow a matching processed information example.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "library entities or data named, such as students/books/loans" },
      { mark: "A1", text: "retrieval/update use explained in the library context" },
    ],
    strict: [
      ...
      "FT: if a different valid scenario is used, award context marks if clearly database-related.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "explanation of first named function" },
      { mark: "B1", text: "second distinct valid DBMS function named" },
      { mark: "M1", text: "explanation of second function" },
      { mark: "B1", text: "third distinct valid DBMS function named" },
      { mark: "M1", text: "explanation of third function" },
    ],
    strict: [
      ...
      "FT: an explanation can earn M1 only if paired with a valid or clearly implied DBMS function.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "security linked to authorised clinic staff or patient details" },
      { mark: "B1", text: "integrity/validation/constraint identified" },
      { mark: "M1", text: "integrity linked to valid appointment/patient data" },
      { mark: "A1", text: "backup/recovery or clear consequence of maintaining reliable clinic data" },
    ],
    strict: [
      ...
      "FT: consequence mark may follow either security or integrity if it is clinic-specific.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "query/search function attributed to DBMS/query processor" },
      { mark: "M1", text: "edit permission/access function attributed to DBMS/access rights" },
      { mark: "B1", text: "clear corrected wording provided" },
      { mark: "A1", text: "distinction explained rather than only naming both terms" },
    ],
    strict: [
      ...
      "FT: if the candidate swaps terms consistently, corrected wording mark cannot be awarded.",
    ],
  },
];
