...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "distinguishes where/access from when/duration" },
      { mark: "A1", text: "uses accurate variable/program terminology" },
      { mark: "B1", text: "gives a relevant local or global variable example" },
    ],
    strict: [
      ...
      "FT: example mark can follow any valid variable in a subroutine or main program context.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "B1", text: "uses accurate scope terminology" },
    ],
    strict: [
      ...
      "FT: explanation marks can follow an answer that clearly separates local and global variables.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains this makes the source of an incorrect value harder to find" },
      { mark: "A1", text: "links this to debugging or tracing difficulty" },
      { mark: "B1", text: "states global variables create shared state/dependence between subroutines" },
      { mark: "M1", text: "explains changes in one part may affect another unexpectedly" },
      { mark: "A1", text: "uses a relevant consequence rather than a vague claim" },
    ],
    strict: [
      ...
      "FT: second reason can be any distinct debugging/maintenance problem caused by shared global state.",
    ],
  },
  {
    title: "Question 4",
    ...
    strict: [
      ...
      "FT: local explanation can follow a candidate's equivalent temporary variable name.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains Temp is outside scope in the main program" },
      { mark: "M1", text: "explains the local variable may no longer be accessible after the procedure ends" },
      { mark: "A1", text: "gives correction: output inside the procedure" },
      { mark: "A1", text: "gives correction: return the value using a function or equivalent" },
      { mark: "B1", text: "keeps explanation in Cambridge pseudocode/algorithm terms" },
    ],
    strict: [
      ...
      "FT: correction marks can follow any equivalent local temporary variable name.",
    ],
  },
];
