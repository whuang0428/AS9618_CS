...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "purpose or benefit linked to fitness tracking/personalised service" },
      { mark: "B1", text: "privacy concern such as unnecessary contacts/location sensitivity" },
      { mark: "M1", text: "concern explained, such as routines revealed or third-party data exposed" },
      { mark: "B1", text: "safeguard such as transparency/consent/minimisation/user control/deletion" },
      { mark: "A1", text: "safeguard linked to reducing named privacy risk" },
    ],
    strict: [
      ...
      "FT: award safeguard mark if it matches a valid concern, even if benefit is weak.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "linked to stated purpose" },
      { mark: "M1", text: "reduced risk if data is breached/misused/shared" },
      { mark: "B1", text: "valid example of unnecessary data avoided" },
      { mark: "A1", text: "consequence linked to privacy/trust/ethical justification" },
    ],
    strict: [
      ...
      "FT: award consequence if the candidate's definition is mostly correct.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "benefit linked to school device context" },
      { mark: "B1", text: "privacy/trust/over-monitoring concern" },
      { mark: "M1", text: "concern explained using students/personal activity/secret monitoring" },
      { mark: "B1", text: "data protection safeguard such as transparency/access restriction/retention limit/scope limit" },
      { mark: "A1", text: "balanced judgement about proportionality or conditions" },
    ],
    strict: [
      ...
      "FT: judgement may support or oppose monitoring if balanced and justified.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "audit trail/accountability or transparency explained" },
      { mark: "A1", text: "at least one safeguard linked to reducing misuse/unauthorised access/privacy risk" },
    ],
    strict: [
      ...
      "FT: award consequence if any named safeguard is valid.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "concern explained, such as tracking innocent people/constant monitoring" },
      ...
      { mark: "M1", text: "safeguard linked to reducing a named risk" },
      { mark: "A1", text: "balanced judgement about proportionality/clear purpose/limits" },
    ],
    strict: [
      ...
      "FT: award judgement mark if consistent with earlier balanced analysis.",
    ],
  },
];
