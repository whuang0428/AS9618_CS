...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "user tricked into revealing confidential information/credentials" },
      { mark: "B1", text: "stolen credentials/password used by attacker" },
      { mark: "M1", text: "attacker gains unauthorised access or impersonates user" },
      { mark: "A1", text: "valid consequence such as data viewed/changed/copied or financial loss" },
    ],
    strict: [
      ...
      "FT: award consequence mark if unauthorised access follows from a valid credential-theft explanation.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "M1", text: "phishing user reveals confidential information/credentials" },
      { mark: "B1", text: "pharming redirects user/traffic to a fake website" },
      { mark: "A1", text: "clear contrast: persuasion by message vs redirection, or correct URL clue" },
    ],
    strict: [
      ...
      "FT: award shared outcome if both mechanisms are at least partially distinguished.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "flooding/large number of requests overwhelms service" },
      ...
      { mark: "A1", text: "second distinct valid control with mechanism, e.g. load balancing/DDoS mitigation/monitoring" },
    ],
    strict: [
      ...
      "FT: award controls if they reduce availability impact even if DoS label is missing.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "target is system/account/network/data" },
      ...
      { mark: "A1", text: "impact linked to company context or further misuse/permission abuse" },
    ],
    strict: [
      ...
      "FT: award impact marks independently after a weak definition if scenario implies unauthorised access.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "justification linked to deceptive message and revealing login details" },
      { mark: "B1", text: "correct URL/fake page classified as pharming" },
      { mark: "M1", text: "justification linked to redirection to fraudulent site" },
      { mark: "B1", text: "many devices flooding server classified as DDoS/DoS" },
      { mark: "A1", text: "justification linked to multiple sources overwhelming service/preventing legitimate access" },
    ],
    strict: [
