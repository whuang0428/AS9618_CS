...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "shows a valid procedure call" },
      { mark: "A1", text: "uses CALL DisplayMenu() or equivalent Cambridge-style call" },
    ],
    strict: [
      ...
      "FT: call mark can follow candidate's equivalent procedure name.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: call/storage mark can follow candidate's function name if consistent.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "A1", text: "gives suitable procedure example" },
      { mark: "B1", text: "states function returns a value" },
      { mark: "A1", text: "gives suitable function example" },
      { mark: "M1", text: "explains returned value can be used by the caller" },
      { mark: "B1", text: "uses accurate terminology such as call, parameter or return" },
    ],
    strict: [
      ...
      "FT: example marks can follow candidate's valid alternative examples.",
    ],
  },
  {
    title: "Question 4",
    ...
    strict: [
      ...
      "FT: return marks can follow candidate's equivalent Boolean labels if clear.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      { mark: "B1", text: "identifies that the subroutine is a function with a return type" },
      { mark: "M1", text: "explains OUTPUT displays to the user" },
      { mark: "M1", text: "explains RETURN sends a value back to the caller" },
      { mark: "A1", text: "states the function must use RETURN" },
      { mark: "A1", text: "states returned expression should match INTEGER return type" },
    ...
    strict: [
      ...
      "FT: correction mark can follow candidate's equivalent calculated variable.",
    ],
  },
];
