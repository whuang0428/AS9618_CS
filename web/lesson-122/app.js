...
const examQuestions = [
  {
    ...
    marking: [
      ...
      { mark: "M1", text: "states ADT is defined by operations/behaviour" },
      { mark: "A1", text: "states implementation is separate from the ADT definition" },
    ],
    strict: [
      ...
      "FT: operation marks can follow candidate's correct ADT rule.",
    ],
  },
  {
    title: "Question 2",
    ...
    strict: [
      ...
      "FT: later trace marks can follow from a single earlier error if operation rule is then applied consistently.",
    ],
  },
  {
    title: "Question 3",
    ...
    strict: [
      ...
      "FT: final queue mark can follow from candidate's consistent FIFO trace.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "states full check should happen before push" },
      { mark: "A1", text: "rejects the PUSH or outputs suitable error" },
      { mark: "A1", text: "states D is not added" },
      { mark: "B1", text: "uses correct stack terminology such as top/push" },
    ],
    strict: [
      ...
      "FT: rejection mark can follow candidate's equivalent maximum-size check.",
    ],
  },
  {
    title: "Question 5",
    ...
    strict: [
      ...
      "FT: pointer update marks can follow candidate's chosen empty-stack convention.",
    ],
  },
];
