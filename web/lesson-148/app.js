...
const examQuestions = [
  {
    ...
    marking: [
      { mark: "M1", text: "initialises PassCount to 0" },
      { mark: "M1", text: "uses a suitable counted loop for 50 marks" },
      { mark: "M1", text: "inputs or reads each mark inside the loop" },
      { mark: "M1", text: "uses selection to test pass condition" },
      { mark: "A1", text: "increments PassCount only when condition is met" },
      { mark: "A1", text: "outputs PassCount after processing all marks" },
    ],
    strict: [
      ...
      "FT: if loop count has a minor error, credit valid counting logic where clear.",
    ],
  },
  {
    title: "Question 2",
    ...
    marking: [
      ...
      { mark: "A1", text: "gives valid procedure example" },
      { mark: "B1", text: "states a function returns a value" },
      { mark: "A1", text: "gives valid function validation example" },
      { mark: "M1", text: "explains returned value can be used by calling code" },
      { mark: "A1", text: "uses accurate validation context such as mark range 0 to 100" },
    ],
    strict: [
      ...
      "FT: credit examples that use different validation rules if technically valid.",
    ],
  },
  {
    title: "Question 3",
    ...
    strict: [
      ...
      "FT: if EOF logic is inverted but read/output/close sequence is otherwise clear, credit independent marks.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      { mark: "M1", text: "opens Scores.txt for APPEND" },
      { mark: "M1", text: "writes the new score to the file" },
      { mark: "A1", text: "closes the file after writing" },
      { mark: "B1", text: "justifies APPEND as adding to the end" },
      { mark: "A1", text: "states existing records are preserved" },
      { mark: "A1", text: "explains WRITE may create/replace contents or is unsuitable for this task" },
    ],
    strict: [
      ...
      "FT: if candidate chooses WRITE but explains appending behaviour correctly, mode mark is lost but later conceptual marks may be credited cautiously.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      { mark: "M1", text: "uses a loop that can repeat until valid input is entered" },
      ...
      { mark: "A1", text: "outputs error or rejects invalid input" },
      { mark: "A1", text: "stops only when mark is valid and can then process the mark" },
    ],
    strict: [
      ...
      "FT: if candidate uses a different valid range, credit loop and type logic but not the stated boundary marks.",
    ],
  },
];
