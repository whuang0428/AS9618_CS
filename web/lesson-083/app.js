...
const examQuestions = [
  {
    title: "Question 1",
    marks: "4 marks",
    prompt: "State two reasons for normalising a database.",
    ...
    marking: [
      ...
      { mark: "M1", text: "explains storing facts once/in appropriate table" },
      { mark: "B1", text: "avoids anomalies or names update/insertion/deletion anomaly" },
      { mark: "A1", text: "links to improved data integrity/consistency" },
    ],
    strict: [
      ...
      "FT: integrity mark can follow a valid redundancy or anomaly point.",
    ],
  },
  {
    title: "Question 2",
    marks: "6 marks",
    prompt: "A table stores StudentID, StudentName, CourseID, CourseTitle and TutorEmail for every enrolment. Explain two problems this may cause.",
    ...
    marking: [
      ...
      { mark: "M1", text: "redundancy linked to every enrolment/student row" },
      { mark: "B1", text: "update anomaly/inconsistent update identified" },
      { mark: "M1", text: "update problem explained with some rows changed and others not" },
      { mark: "B1", text: "insertion or deletion anomaly identified" },
      { mark: "A1", text: "insertion/deletion problem explained in course/enrolment context" },
    ],
    strict: [
      ...
      "FT: accept either insertion or deletion anomaly for the final pair.",
    ],
  },
  {
    title: "Question 3",
    ...
    marking: [
      ...
      { mark: "M1", text: "primary key or unique identifier roles described correctly" },
      { mark: "M1", text: "foreign key/linking role described correctly" },
      { mark: "A1", text: "explains reduced repetition of student/course details" },
    ],
    strict: [
      ...
      "FT: key/link marks can follow any sensible decomposed design.",
    ],
  },
  {
    title: "Question 4",
    ...
    marking: [
      ...
      { mark: "M1", text: "problem such as hard to search/update/validate individual numbers" },
      { mark: "B1", text: "separate related table suggested" },
      { mark: "A1", text: "one phone number per record and linked to Student/StudentID" },
    ],
    strict: [
      ...
      "FT: solution mark can follow any valid repeated-field example.",
    ],
  },
  {
    title: "Question 5",
    ...
    marking: [
      ...
      { mark: "M1", text: "benefit explained with repeated fact example" },
      { mark: "B1", text: "limitation: more tables/increased complexity" },
      { mark: "M1", text: "limitation explained, e.g. data must be combined from tables" },
      { mark: "A1", text: "balanced judgement based on scenario/data repetition" },
    ],
    strict: [
      ...
      "FT: final judgement may support normalisation strongly if the condition is stated.",
    ],
  },
];
